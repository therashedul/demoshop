                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center">
                                        <h4><?php echo e(trans('Add Purchase')); ?></h4>
                                    </div>
                                    <div class="card-body">
                                        <p class="italic">
                                            ...
                                            <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="order_tax_rate">
                                                                <option value="0"><?php echo e(trans('No Tax')); ?>
                                                ...
                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-primary"
                                                        id="submit-btn"><?php echo e(trans('submit')); ?></button>
                                                </div>
                                            </div>
                                        </div>
...
<?php /**PATH F:\xampp74\htdocs\demoshop\resources\views/components/backend/superAdmin/purchase/purchasecreate.blade.php ENDPATH**/ ?>