            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('Update Sale')); ?></h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small><?php echo e(trans('The field labels marked with * are required input fields')); ?>.</small></p>
                        <?php echo Form::open(['route' => ['superAdmin.sale.update', $limssaledata->id], 'method' => 'put', 'files' => true, 'id' => 'payment-form']); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="created_at" class="form-control date" value="<?php echo e(date($general_setting->date_format, strtotime($limssaledata->created_at->toDateString()))); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('reference')); ?></label>
                                            <p><strong><?php echo e($limssaledata->reference_no); ?></strong></p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('customer')); ?> *</label>
                                            <input type="hidden" name="customer_id_hidden" value="<?php echo e($limssaledata->customer_id); ?>" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="warehouse_id_hidden" value="<?php echo e($limssaledata->warehouse_id); ?>" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="biller_id_hidden" value="<?php echo e($limssaledata->biller_id); ?>" />
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                    <?php $__currentLoopData = $limsproductsaledata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                    <?php
                                                        ...
                                                        <td><?php echo e($product_data->product_name); ?> 
                                                            ...
                                                            <input type="hidden" class="product-type" value="<?php echo e($product_data->product_type); ?>" />
                                                        </td>
                                                        <td><?php echo e($product_data->product_code); ?></td>
                                                        ...
                                                        <td><?php echo e(date($general_setting->date_format, strtotime($product_batch_data->expired_date))); ?></td>
                                                        <?php else: ?>
                                                        <td>
                                                        ...
                                                        <input type="hidden" class="product-code" name="product_code[]" value="<?php echo e($product_data->product_code); ?>"/>
                                                        ...
                                                        <input type="hidden" class="sale-unit" name="sale_unit[]" value="<?php echo e($unit_code); ?>"/>
                                                ...
                                                <tfoot class="tfoot active">
                                                    ...
                                                    <th id="total-qty"><?php echo e($limssaledata->total_qty); ?></th>
                                                    <th></th>
                                                    <th></th>
                                                    <th></th>
                                                    <th id="total-discount"><?php echo e(number_format((float)$limssaledata->total_discount, 2, '.', '')); ?></th>
                                                    <th id="total-tax"><?php echo e(number_format((float)$limssaledata->total_tax, 2, '.', '')); ?></th>
                                                    <th id="total"><?php echo e(number_format((float)$limssaledata->total_price, 2, '.', '')); ?></th>
                                                    <th><i class="dripicons-trash"></i></th>
                                                </tfoot>
                                            </table>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_qty" value="<?php echo e($limssaledata->total_qty); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_discount" value="<?php echo e($limssaledata->total_discount); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_tax" value="<?php echo e($limssaledata->total_tax); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_price" value="<?php echo e($limssaledata->total_price); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="item" value="<?php echo e($limssaledata->item); ?>" />
                                            <input type="hidden" name="order_tax" value="<?php echo e($limssaledata->order_tax); ?>"/>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <?php if($limssaledata->coupon_id): ?>
                                            <?php
                                            ...
                                            <input type="hidden" name="coupon_discount" value="<?php echo e($limssaledata->coupon_discount); ?>">

                                        <?php else: ?>
                                            <input type="hidden" name="coupon_active" value="0" />
                                        <?php endif; ?>
                                        <div class="form-group">
                                            <input type="hidden" name="grand_total" value="<?php echo e($limssaledata->grand_total); ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input type="hidden" name="order_tax_rate_hidden" value="<?php echo e($limssaledata->order_tax_rate); ?>">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="order_discount_type">
                                                <?php if($limssaledata->order_discount_type == 'Percentage'): ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <?php echo e(trans('Order Discount Value')); ?>

                                            </label>
                                            <input type="number" name="order_discount_value" class="form-control" value="<?php if($limssaledata->order_discount_value): ?><?php echo e($limssaledata->order_discount_value); ?><?php else: ?><?php echo e($limssaledata->order_discount); ?><?php endif; ?>" step="any" />
                                            <input type="hidden" name="order_discount" value="<?php echo e($limssaledata->order_discount); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="shipping_cost" class="form-control" value="<?php echo e($limssaledata->shipping_cost); ?>" step="any" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Attach Document')); ?></label> <i class="dripicons-question" data-toggle="tooltip" title="Only jpg, jpeg, png, gif, pdf, csv, docx, xlsx and txt file is supported"></i>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="sale_status_hidden" value="<?php echo e($limssaledata->sale_status); ?>" />
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong><?php echo e(trans('Coupon Discount')); ?></strong>
                                            </label>
                                            <p class="mt-2 pl-2"><strong id="coupon-text"><?php echo e(number_format((float)$limssaledata->coupon_discount, 2, '.', '')); ?></strong></p>
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" class="form-control" name="sale_note" ><?php echo e($limssaledata->sale_note); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Staff Note')); ?></label>
                                            <textarea rows="5" class="form-control" name="staff_note"><?php echo e($limssaledata->staff_note); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input type="hidden" name="payment_status" value="<?php echo e($limssaledata->payment_status); ?>" />
                                            <input type="hidden" name="paid_amount" value="<?php echo e($limssaledata->paid_amount); ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input type="submit" value="<?php echo e(trans('submit')); ?>" class="btn btn-primary" id="submit-button">
                                </div>
                            </div>
                        </div>
                        <?php echo Form::close(); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <button type="button" name="update_btn" class="btn btn-primary"><?php echo e(trans('update')); ?></button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div id="cash-register-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('Add Cash Register')); ?></h5>
              <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
              <p class="italic"><small><?php echo e(trans('The field labels marked with * are required input fields')); ?>.</small></p>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(flag){
                    ...
                    // cols += '<td><button type="button" class="ibtnDel btn btn-md btn-danger"><?php echo e(trans("delete")); ?></button></td>';
    ...
    function checkDiscount(qty, flag) {
        ...
        if(flag) {
            $.ajax({
                type: 'GET',
                async: false,
                url: "<?php echo e(route('superAdmin.sale.check_discount')); ?>" + '?qty=' + qty + '&customer_id='+customer_id+'&product_id='+product_id,
...
<?php $__env->stopPush(); ?>
<?php /**PATH F:\xampp74\htdocs\demoshop\resources\views/components/backend/superAdmin/sale/saleedit.blade.php ENDPATH**/ ?>