            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('Add Transfer')); ?></h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small><?php echo e(trans('The field labels marked with * are required input fields')); ?>.</small></p>
                        <?php echo Form::open(['route' => 'superAdmin.transfers.store', 'method' => 'post', 'files' => true, 'id' => 'transfer-form']); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('From Warehouse')); ?> *</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('To Warehouse')); ?> *</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control selectpicker">
                                                ...
                                                <option value="3"><?php echo e(trans('Sent')); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><?php echo e(trans('Net Unit Cost')); ?></th>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Shipping Cost')); ?></label>
...
$('select[name="from_warehouse_id"]').on('change', function() {
    var id = $(this).val();
    var url = "<?php echo e(route('superAdmin.transfers/getproduct', ':id')); ?>";
...
$('button[name="update_btn"]').on("click", function() {
    ...
    $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.purchase-unit').val(temp_unit_code[position]);
...
function productSearch(data){
    var urlSearch = "<?php echo e(route('superAdmin.product_transfer.search')); ?>";
    $.ajax({
        type: 'GET',
        url: urlSearch,
        data: {
...
<?php echo $__env->make('layouts.deshboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp74\htdocs\demoshop\resources\views/superadmin/transfer/create.blade.php ENDPATH**/ ?>