            ...
            <table id="cash-register-table" class="table">
                <thead>
                    <tr>
                        ...
                        <th><?php echo e(trans('Cash in Hand')); ?></th>
                        <th><?php echo e(trans('Opened at')); ?></th>
                        <th><?php echo e(trans('Closed at')); ?></th>
                        <th><?php echo e(trans('Status')); ?></th>
                        <th class="not-exported"><?php echo e(trans('action')); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <?php $__currentLoopData = $limscashregisterall; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cash_register): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-id="<?php echo e($cash_register->id); ?>">
                            <td><?php echo e($key); ?></td>
                            <td><?php echo e($cash_register->user->name); ?></td>
                            <td><?php echo e(optional($cash_register->warehouse)->name); ?></td>
                            <td><?php echo e($cash_register->cash_in_hand); ?></td>
                            <td>
                                <?php echo e(date('date' . ' h:i:s', strtotime($cash_register->created_at))); ?>
                            ...
                            <?php else: ?>
                                <td><?php echo e(date('date' . ' h:i:s', strtotime($cash_register->updated_at))); ?>

                                </td>
                                <td>
                                    <div class="badge badge-danger"><?php echo e(trans('Closed')); ?></div>
                                </td>
                            <?php endif; ?>
                            <td>
                                <div class="btn-group">
                                    <button type="button" data-id="<?php echo e($cash_register->id); ?>"
                                        class="register-details-btn btn btn-sm btn-info" data-toggle="modal"
                                        data-target="#register-details-modal" title="<?php echo e(trans('View')); ?>"> View </button>
                                </div>
                            </td>
                        </tr>
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('Cash Register Details')); ?></h5>
                        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                                aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                    </div>
                    <div class="modal-body">
                        <p><?php echo e(trans('Please review the transaction and payments.')); ?></p>
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-hover">
                                    <tbody>
                                        <tr>
                                            <td><?php echo e(trans('Cash in Hand')); ?>:</td>
                                            <td id="cash_in_hand" class="text-right">100</td>
                                        </tr>
                                        <tr>
                                            <td><?php echo e(trans('Total Sale Amount')); ?>:</td>
                                            <td id="total_sale_amount" class="text-right"></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo e(trans('Total Payment')); ?>:</td>
                                            <td id="total_payment" class="text-right"></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo e(trans('Cash Payment')); ?>:</td>
                                            <td id="cash_payment" class="text-right"></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo e(trans('Credit Card Payment')); ?>:</td>
                                            <td id="credit_card_payment" class="text-right"></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo e(trans('Cheque Payment')); ?>:</td>
                                            <td id="cheque_payment" class="text-right"></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo e(trans('Gift Card Payment')); ?>:</td>
                                            <td id="gift_card_payment" class="text-right"></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo e(trans('Paypal Payment')); ?>:</td>
                                            <td id="paypal_payment" class="text-right"></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo e(trans('Total Sale Return')); ?>:</td>
                                            <td id="total_sale_return" class="text-right"></td>
                                        </tr>
                                        <tr>
                                            <td><?php echo e(trans('Total Expense')); ?>:</td>
                                            <td id="total_expense" class="text-right"></td>
                                        </tr>
                                        <tr>
                                            <td><strong><?php echo e(trans('Total Cash')); ?>:</strong></td>
                            ...
                            <div class="col-md-6" id="closing-section">
                                <form action="<?php echo e(route('superAdmin.cashRegister.close')); ?>" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-primary"
                                        onclick="return confirmClose()"><?php echo e(trans('Close Register')); ?></button>
                                </form>
                            </div>
                        </div>
                    </div>
...
<?php $__env->startPush('custom_scripts'); ?>
    <script type="text/javascript">
        ...
        $(".register-details-btn").on("click", function(e) {
            id = $(this).data('id');
            getUrl = "<?php echo e(url ( 'superAdmin/cash-register/getDetails' )); ?>" + "/" + id ;         
            $.ajax({
                url: getUrl,  
...
<?php $__env->stopPush(); ?>
<?php /**PATH F:\xampp74\htdocs\demoshop\resources\views/components/backend/superAdmin/cash_register/index.blade.php ENDPATH**/ ?>