                               ...
                               <select class="form-control up-category categoryName upCategory" id="categoryName"
                                   ...
                                   <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <option value="<?php echo e($category->id); ?>">
                                           <?php echo e($category->{'slug_' . app()->getLocale()}); ?>
   ...
   <script type="text/javascript">
       ...
       $(document).on('click', '.publish', function(e) {
           ...
           var url = "<?php echo e(route('superAdmin.category.publish', ':id')); ?>";
       ...
       $(document).on('click', '.unpublish', function(e) {
           e.preventDefault();
           let id = $(this).data('id');
           let url = "<?php echo e(route('superAdmin.category.unpublish', ':id')); ?>";
   ...
   <script type="text/javascript">
       $(function() {
           ...
           var table = $('.data-table').DataTable({
               ...
               // serverSide: true,
               // ajax: {
               //     url: "<?php echo e(route('superAdmin.category')); ?>",
               // },
               // columns: [{
               //         data: 'DT_RowIndex',
               //         name: 'DT_RowIndex'
                       ...
                       render: function(data, type, row, meta) {
                           if (type === 'display') {
                               data = '<a href="http://127.0.0.1:8000/firma/' + encodeURIComponent(
                                   data) + '">' + row.name_<?php echo e($language); ?> + '</a>';
                           }
                           return data;
                       }
                   },
           ...
           $('body').on('click', '.editPost', function() {
               ...
               var url = "<?php echo e(route('superAdmin.category.update', ':id')); ?>";
               ...
               // $.get("<?php echo e(route('superAdmin.category.store')); ?>" + '/' + id + '/edit', function(data) {
           ...
           $('body').on('click', '.deleteCategory', function(e) {
               ...
               var url = "<?php echo e(route('superAdmin.category.deleted', ':id')); ?>";
               var catUrl = url.replace(':id', id);
...
<?php /**PATH F:\xampp74\htdocs\demoshop\resources\views/components/backend/superAdmin/category/catindex.blade.php ENDPATH**/ ?>