...
<div style="max-width:400px;margin:0 auto">
    ...
    <div class="hidden-print">
        <table>
            <tr>
                <td><a href="<?php echo e($url); ?>" class="btn btn-info"><i class="fa fa-arrow-left"></i> <?php echo e(trans('Back')); ?></a> </td>
                <td><button onclick="window.print();" class="btn btn-primary"><i class="dripicons-print"></i> <?php echo e(trans('Print')); ?></button></td>
            </tr>
        </table>
        <br>
    </div>
    ...
    <div id="receipt-data">
        <div class="centered">
            <?php if($general_setting->site_logo): ?>
                <img src="<?php echo e(url('public/logo', $general_setting->site_logo)); ?>" height="42" width="50" style="margin:10px 0;">
            <?php endif; ?>

            <h2><?php echo e($lims_biller_data->company_name); ?></h2>

            <p><?php echo e(trans('Address')); ?>: <?php echo e($lims_warehouse_data->address); ?>

                <br><?php echo e(trans('Phone Number')); ?>: <?php echo e($lims_warehouse_data->phone); ?>

                <?php if($general_setting->vat_registration_number): ?>
                <br><?php echo e(trans('VAT Number')); ?>: <?php echo e($general_setting->vat_registration_number); ?>

                <?php endif; ?>
            </p>
        </div>
        <p><?php echo e(trans('Date')); ?>: <?php echo e(date($general_setting->date_format, strtotime($lims_sale_data->created_at->toDateString()))); ?><br>
            <?php echo e(trans('reference')); ?>: <?php echo e($lims_sale_data->reference_no); ?><br>
            <?php echo e(trans('customer')); ?>: <?php echo e($lims_customer_data->name); ?>

            <?php if($lims_sale_data->table_id): ?>
            <br><?php echo e(trans('Table')); ?>: <?php echo e($lims_sale_data->table->name); ?>

            <br><?php echo e(trans('Queue')); ?>: <?php echo e($lims_sale_data->queue); ?>
        ...
        <table class="table-data">
            <tbody>
                ...
                <?php
                    ...
                    elseif($product_sale_data->product_batch_id) {
                        ...
                        $product_name = $lims_product_data->name.' ['.trans("Batch No").':'.$product_batch_data->batch_no.']';
                    }
                    else
                    ...
                    <td colspan="2">
                        ...
                        <?php $__currentLoopData = $product_custom_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $fieldName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($lims_product_data->$field_name): ?>
                                <?php if(!$index): ?>
                                <br><?php echo e($fieldName.': '.$lims_product_data->$field_name); ?>

                                <?php else: ?>
                                <?php echo e('/'.$fieldName.': '.$lims_product_data->$field_name); ?>
                        ...
                        <?php if($product_sale_data->tax_rate): ?>
                            ...
                            [<?php echo e(trans('Tax')); ?> (<?php echo e($product_sale_data->tax_rate); ?>%): <?php echo e($product_sale_data->tax); ?>]
                        <?php endif; ?>
                    </td>
            ...
            <!-- <tfoot> -->
                <tr>
                    <th colspan="2" style="text-align:left"><?php echo e(trans('Total')); ?></th>
                ...
                <tr>
                    <th colspan="2" style="text-align:left"><?php echo e(trans('Order Tax')); ?></th>
                ...
                <tr>
                    <th colspan="2" style="text-align:left"><?php echo e(trans('Order Discount')); ?></th>
                ...
                <tr>
                    <th colspan="2" style="text-align:left"><?php echo e(trans('Coupon Discount')); ?></th>
                ...
                <tr>
                    <th colspan="2" style="text-align:left"><?php echo e(trans('Shipping Cost')); ?></th>
                    <th style="text-align:right"><?php echo e(number_format((float)($lims_sale_data->shipping_cost), 2, '.', ',')); ?></th>
                </tr>
                <?php endif; ?>
                <tr>
                    <th colspan="2" style="text-align:left"><?php echo e(trans('grand total')); ?></th>
                ...
                <tr>
                    ...
                    <th class="centered" colspan="3"><?php echo e(trans('In Words')); ?>:  <span><?php echo e(str_replace("-"," ",$numberInWords)); ?></span></th>
                    <?php else: ?>
                    <th class="centered" colspan="3"><?php echo e(trans('In Words')); ?>: <span><?php echo e(str_replace("-"," ",$numberInWords)); ?></span> </th>
                    <?php endif; ?>
                </tr>
        ...
        <table>
            <tbody>
                ...
                <tr style="background-color:#ddd;">
                    <td style="padding: 5px;width:30%"><?php echo e(trans('Paid By')); ?>: <?php echo e($payment_data->paying_method); ?></td>
                    <td style="padding: 5px;width:40%"><?php echo e(trans('Amount')); ?>: <?php echo e(number_format((float)($payment_data->amount), 2, '.', ',')); ?></td>
                    <td style="padding: 5px;width:30%"><?php echo e(trans('Change')); ?>: <?php echo e(number_format((float)$payment_data->change, 2, '.', ',')); ?></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <tr><td class="centered" colspan="3"><?php echo e(trans('Thank you for shopping with us. Please come again')); ?></td></tr>
                <tr>
        ...
        <!-- <div class="centered" style="margin:30px 0 50px">
            <small><?php echo e(trans('Invoice Generated By')); ?> <?php echo e($general_setting->site_title); ?>.
            <?php echo e(trans('Developed By')); ?> LionCoders</strong></small>
        </div> -->
    </div>
</div>
...
<script type="text/javascript">
    ...
    setTimeout(auto_print, 100000);
</script>

</body>
</html>
<?php /**PATH F:\xampp74\htdocs\demoshop\resources\views/superadmin/sale/invoice.blade.php ENDPATH**/ ?>