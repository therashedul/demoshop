...
<script type="text/javascript" src="https://cdn.datatables.net/fixedheader/3.1.6/js/dataTables.fixedHeader.min.js"></script>
 ...
 <script type="text/javascript" src="<?php echo e(asset('build/js/bootstrap-datetimepicker.js')); ?>" charset="UTF-8"></script>
 <script type="text/javascript" src="<?php echo e(asset('build/js/bootstrap-datetimepicker.fr.js')); ?> " charset="UTF-8"></script>
 <!-- daterangepicker -->
 ...
 <script src="<?php echo e(asset('dist/js/pages/dashboard.js')); ?>"></script>
     ...
     <script>
        $(() => {
            ...
            // Send data to the Laravel controller using AJAX
            $.ajax({
                type: "POST",
                url: "<?php echo e(url('/process-device-size')); ?>",
                data: {
                    width: deviceWidth,
                    height: deviceHeight,
...
<?php /**PATH F:\xampp74\htdocs\demoshop\resources\views/asset/bottomfooter.blade.php ENDPATH**/ ?>