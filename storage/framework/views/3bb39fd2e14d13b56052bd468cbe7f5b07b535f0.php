    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body" style="padding-bottom: 0">
                        <?php echo Form::open(['route' => 'superAdmin.sale.store', 'method' => 'post', 'files' => true, 'class' => 'payment-form']); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row" style="display: none;">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_discount" value="<?php echo e(number_format(0, 2, '.', '')); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="hidden" name="total_tax" value="<?php echo e(number_format(0, 2, '.', '')); ?>"/>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                ...
                                <div class="col-12 totals" style="border-top: 2px solid #e4e6fc; padding-top: 10px;">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Total')); ?></span><span id="subtotal"><?php echo e(number_format(0, 2, '.', '')); ?></span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Discount')); ?> <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#order-discount-modal"> <i class="dripicons-document-edit"></i></button></span><span id="discount"><?php echo e(number_format(0, 2, '.', '')); ?></span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Coupon')); ?> <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#coupon-modal"><i class="dripicons-document-edit"></i></button></span><span id="coupon-text"><?php echo e(number_format(0, 2, '.', '')); ?></span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Tax')); ?> <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#order-tax"><i class="dripicons-document-edit"></i></button></span><span id="tax"><?php echo e(number_format(0, 2, '.', '')); ?></span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Shipping')); ?> <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#shipping-cost-modal"><i class="dripicons-document-edit"></i></button></span><span id="shipping-cost"><?php echo e(number_format(0, 2, '.', '')); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="payment-amount">
                        <h2><?php echo e(trans('file.grand total')); ?> <span id="grand-total"><?php echo e(number_format(0, 2, '.', '')); ?></span></h2>
                    </div>
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <p id="change" class="ml-2"><?php echo e(number_format(0, 2, '.', '')); ?></p>
                                        </div>
                                        <div class="col-md-3 mt-1">
                          ...
                          <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                            <div class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                  ...
                                  <li class="dropdown-item"><a href="<?php echo e(route('superAdmin.products.create')); ?>"><?php echo e(__('file.add_product')); ?></a></li>
                                  <li class="dropdown-item"><a href="<?php echo e(route('superAdmin.purchase.create')); ?>"><?php echo e(trans('file.Add Purchase')); ?></a></li>
                                  <li class="dropdown-item"><a href="<?php echo e(route('superAdmin.sale.create')); ?>"><?php echo e(trans('file.Add Sale')); ?></a></li>

                                <li class="dropdown-item"><a data-toggle="modal" data-target="#expense-modal"> <?php echo e(trans('file.Add Expense')); ?></a></li>
                                
                                <li class="dropdown-item"><a href="<?php echo e(route('superAdmin.transfers.create')); ?>"><?php echo e(trans('file.Add Transfer')); ?></a></li>
                                ...
                                <li class="dropdown-item"><a href="<?php echo e(route('superAdmin.customer.create')); ?>"><?php echo e(trans('file.Add Customer')); ?></a></li>
                                <li class="dropdown-item"><a href="<?php echo e(route('superAdmin.biller.create')); ?>"><?php echo e(trans('file.Add Biller')); ?></a></li>
                                <li class="dropdown-item"><a href="<?php echo e(route('superAdmin.supplier.create')); ?>"><?php echo e(trans('file.Add Supplier')); ?></a></li>
                            ...
                            <li class="nav-item"><a class="dropdown-item" data-toggle="tooltip" href="<?php echo e(route('superAdmin.possetting')); ?>" title="<?php echo e(trans('file.POS Setting')); ?>"><i class="dripicons-gear"></i></a> </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('superAdmin.sale.printLastReciept')); ?>" data-toggle="tooltip" title="<?php echo e(trans('file.Print Last Reciept')); ?>"><i class="dripicons-print"></i></a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="right-sidebar">
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('superAdmin.ganeralsetting')); ?>"><i class="dripicons-gear"></i> <?php echo e(trans('file.settings')); ?></a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="<?php echo e(url('superAdmin.holidays.myHoliday/'.date('Y').'/'.date('m'))); ?>"><i class="dripicons-vibrate"></i> <?php echo e(trans('file.My Holiday')); ?></a>
                                    </li>
                                    <?php endif; ?>
                                    <li>
                        ...
                        <div class="row ml-2 mt-3">
                            ...
                            <div class="col-md-3 category-img text-center" data-category="<?php echo e($category->id); ?>">
                                <?php if($category->category_img): ?>
                                    <img  src="<?php echo e(url('thumbnail', $category->category_img)); ?>" />
                                <?php else: ?>
                                    <img  src="<?php echo e(url('thumbnail/zummXD2dvAtI.png')); ?>" />
                                <?php endif; ?>
                                <p class="text-center"><?php echo e($category->name_en); ?></p>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                        ...
                        <div class="row ml-2 mt-3">
                            ...
                            <?php if($brand->brand_image): ?>
                                <div class="col-md-3 brand-img text-center" data-brand="<?php echo e($brand->id); ?>">
                                    <img  src="<?php echo e(url('thumbnail',$brand->brand_image)); ?>" />
                                    <p class="text-center"><?php echo e($brand->brand_name); ?></p>
                                </div>
                            <?php else: ?>
                    ...
                    <div class="col-md-12 mt-1 table-container">
                        <table id="product-table" class="table no-shadow product-list">
                            ...
                            <?php for($i=0; $i < ceil($product_number/5); $i++): ?>
                                <tr>
                                    <td class="product-img sound-btn" title="<?php echo e($lims_product_list[0+$i*5]->product_name); ?>" data-product ="<?php echo e($lims_product_list[0+$i*5]->product_code . ' (' . $lims_product_list[0+$i*5]->product_name . ')'); ?>"><img  src="<?php echo e(url('thumbnail',$lims_product_list[0+$i*5]->base_image)); ?>" width="100%" />
                                        <p><?php echo e($lims_product_list[0+$i*5]->product_name); ?></p>
                                        <span><?php echo e($lims_product_list[0+$i*5]->product_code); ?></span>
                                    </td>
                                    <?php if(!empty($lims_product_list[1+$i*5])): ?>
                                    <td class="product-img sound-btn" title="<?php echo e($lims_product_list[1+$i*5]->product_name); ?>" data-product ="<?php echo e($lims_product_list[1+$i*5]->product_code . ' (' . $lims_product_list[1+$i*5]->product_name . ')'); ?>"><img  src="<?php echo e(url('thumbnail',$lims_product_list[1+$i*5]->base_image)); ?>" width="100%" />
                                        <p><?php echo e($lims_product_list[1+$i*5]->product_name); ?></p>
                                        <span><?php echo e($lims_product_list[1+$i*5]->product_code); ?></span>
                                    </td>
                                    <?php else: ?>
                                    <td style="border:none;"></td>
                                    <?php endif; ?>
                                    <?php if(!empty($lims_product_list[2+$i*5])): ?>
                                    <td class="product-img sound-btn" title="<?php echo e($lims_product_list[2+$i*5]->product_name); ?>" data-product ="<?php echo e($lims_product_list[2+$i*5]->product_code . ' (' . $lims_product_list[2+$i*5]->product_name . ')'); ?>"><img  src="<?php echo e(url('thumbnail',$lims_product_list[2+$i*5]->base_image)); ?>" width="100%" />
                                        <p><?php echo e($lims_product_list[2+$i*5]->product_name); ?></p>
                                        <span><?php echo e($lims_product_list[2+$i*5]->product_code); ?></span>
                                    </td>
                                    <?php else: ?>
                                    <td style="border:none;"></td>
                                    <?php endif; ?>
                                    <?php if(!empty($lims_product_list[3+$i*5])): ?>
                                    <td class="product-img sound-btn" title="<?php echo e($lims_product_list[3+$i*5]->product_name); ?>" data-product ="<?php echo e($lims_product_list[3+$i*5]->product_code . ' (' . $lims_product_list[3+$i*5]->product_name . ')'); ?>"><img  src="<?php echo e(url('thumbnail',$lims_product_list[3+$i*5]->base_image)); ?>" width="100%" />
                                        <p><?php echo e($lims_product_list[3+$i*5]->product_name); ?></p>
                                        <span><?php echo e($lims_product_list[3+$i*5]->product_code); ?></span>
                                    </td>
                                    <?php else: ?>
                                    <td style="border:none;"></td>
                                    <?php endif; ?>
                                    <?php if(!empty($lims_product_list[4+$i*5])): ?>
                                    <td class="product-img sound-btn" title="<?php echo e($lims_product_list[4+$i*5]->product_name); ?>" data-product ="<?php echo e($lims_product_list[4+$i*5]->product_code . ' (' . $lims_product_list[4+$i*5]->product_name . ')'); ?>"><img  src="<?php echo e(url('thumbnail',$lims_product_list[4+$i*5]->base_image)); ?>" width="100%" />
                                        <p><?php echo e($lims_product_list[4+$i*5]->product_name); ?></p>
                                        <span><?php echo e($lims_product_list[4+$i*5]->product_code); ?></span>
                                    </td>
                                    <?php else: ?>
                                    <td style="border:none;"></td>
                                    <?php endif; ?>
            ...
            <div id="addCustomer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                  <div class="modal-content">
                    <?php echo Form::open(['route' => 'superAdmin.customer.store', 'method' => 'post', 'files' => true, 'id' => 'customer-form']); ?>
                                ...
                                <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <div class="btn-group">
                                            <a href="<?php echo e(route('superAdmin.sale.edit', $sale->id)); ?>" class="btn btn-success btn-sm" title="Edit"><i class="dripicons-document-edit"></i></a>&nbsp;
                                            <?php echo e(Form::open(['route' => ['superAdmin.sale.deleted', $sale->id], 'method' => 'POST'] )); ?>
            ...
            <div id="cash-register-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                  <div class="modal-content">
                    <?php echo Form::open(['route' => 'superAdmin.cashRegister.store', 'method' => 'post']); ?>
                      ...
                      <p><?php echo e(trans('file.Please review the transaction and payments.')); ?></p>
                        <div class="row">
                            ...
                            <div class="col-md-6" id="closing-section">
                              <form action="<?php echo e(route('superAdmin.cashRegister.close')); ?>" method="POST">
                                  <?php echo csrf_field(); ?>
...
<script type="text/javascript">
    ...
    <?php if(!empty($limspossettingdata->stripe_public_key)): ?>
...
<?php if(!empty($limspossettingdata->productnumber)): ?>
var product_row_number = <?php echo json_encode($limspossettingdata->productnumber) ?>;
<?php else: ?>
<?php endif; ?>
var rowindex;
...
//   });
  ...
  function calculateTodayProfit(warehouse_id) {
      $.ajax({
            url: 'sale.todayProfit/' + warehouse_id,
            type: "GET",
            success:function(data) {
...
var url = "<?php echo e(route('superAdmin.sale.getcustomergroup',':id')); ?>";
...
var url = "<?php echo e(route('superAdmin.sale.getProduct',':id')); ?>";
var getUrl = url.replace(':id', id);
$.get(getUrl, function(data) {
    lims_product_array = [];
    product_code = data[0];
...
$('.category-img').on('click', function(){
    ...
    $.get('sale.getProductFilter/' + category_id + '/' + brand_id, function(data) {
    // $.get(getUrl, function(data) {
    ...
    if (Object.keys(data).length != 0) {
        $.each(data['product_name'], function(index) {
            ...
            if(index % 5 == 0 && index != 0)
                tableData += '</tr><tr><td class="product-img sound-btn" title="'+data['product_name'][index]+'" data-product = "'+product_info+'"><img  src="<?php echo e(asset('/')); ?>thumbnail/'+data['product_image'][index]+'" width="100%" /><p>'+data['product_name'][index]+'</p><span>'+data['product_code'][index]+'</span></td>';
            else
                tableData += '<td class="product-img sound-btn" title="'+data['product_name'][index]+'" data-product = "'+product_info+'"><img  src="<?php echo e(asset('/')); ?>thumbnail/'+data['product_image'][index]+'" width="100%" /><p>'+data['product_name'][index]+'</p><span>'+data['product_code'][index]+'</span></td>';
        });
...
$("#myTable").on("change", ".batch-no", function () {
    ...
    var warehouse_id = $('#warehouse_id').val();
        ...
        $.get('sale.checkBatchAvailability/' + product_id + '/' + $(this).val() + '/' + warehouse_id, function(data) {
        if(data['message'] != 'ok') {
            alert(data['message']);
...
function productSearch(data) {
    ...
    var getUrl = "<?php echo e(route('superAdmin.sale.productSearch')); ?>";
    $.ajax({
        type: 'GET',
        url: getUrl,
        data: {
        ...
        success: function(data) {
            ...
            if (pre_qty > 0) {
                ...
                if(!data[11] && product_warehouse_price[pos]) {
                    product_price[rowindex] = parseFloat(product_warehouse_price[pos] ) + parseFloat(product_warehouse_price[pos] * customer_group_rate);
                }
                else{
                    product_price[rowindex] = parseFloat(data[2] ) + parseFloat(data[2]  * customer_group_rate);
                }
                flag = 0;
                checkQuantity(String(qty), true);
                flag = 0;
                ...
                if(parseFloat(value['quantity']) <= parseFloat(value['used']))
                    ...
                    if(parseFloat($('input[name="grand_total"]').val()) >= value['minimum_amount']) {
                        ...
                        if(!$('input[name="coupon_active"]').val())
                            alert('Congratulation! You got '+value['amount']);
...
function giftCard() {
    $(".gift-card").show();
    getUrl = "<?php echo e(route('superAdmin.sale.getGiftCard')); ?>";
    $.ajax({
        url: getUrl,
...
<?php echo $__env->make('layouts.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp74\htdocs\demoshop\resources\views/superadmin/sale/pos.blade.php ENDPATH**/ ?>