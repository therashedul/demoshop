    ...
    <div class="container px-4">
        <div class="row">
            ...
            <div class="col-md-2 mt-4">
                <a class="btn btn-info mb-2 submitOnImage" href="javascript:void(0)" id="createNewbrand">
                    Add New Brand</a>
            </div>
        </div>
        <div class="row">
    ...
    <div class="modal  fade" id="ajaxModelexa" tabindex="-1" aria-labelledby="addbrandModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable brand-modal">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group" id="imageUpload">
                            <label class="col-form-label col-md-12 col-sm-12 label-align">Brand
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.publish', function(e) {
            ...
            var url = "<?php echo e(route('superAdmin.brand.publish', ':id')); ?>";
        ...
        $(document).on('click', '.unpublish', function(e) {
            e.preventDefault();
            let id = $(this).data('id');
            let url = "<?php echo e(route('superAdmin.brand.unpublish', ':id')); ?>";
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('superAdmin.brand')); ?>",
                    data: function(d) {
            ...
            $('#submit-all').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('superAdmin.brand.store')); ?>",
                    type: "POST",
            ...
            $('body').on('click', '.editPost', function() {
                ...
                var url = "<?php echo e(route('superAdmin.brand.update', ':id')); ?>";
                var catUrl = url.replace(':id', id);

                let nameEn = $(this).data('brand_name');
                let status = $(this).data('status');
                let image = $(this).data('brand_image');
            ...
            $('body').on('click', '.deletebrand', function(e) {
                ...
                var url = "<?php echo e(route('superAdmin.brand.deleted', ':id')); ?>";
                var catUrl = url.replace(':id', id);
...
<?php /**PATH F:\xampp74\htdocs\demoshop\resources\views/components/backend/superAdmin/brand/index.blade.php ENDPATH**/ ?>