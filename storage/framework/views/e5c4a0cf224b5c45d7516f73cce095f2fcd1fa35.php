    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.publish', function(e) {
            ...
            var url = "<?php echo e(route('superAdmin.biller.publish', ':id')); ?>";
        ...
        $(document).on('click', '.unpublish', function(e) {
            e.preventDefault();
            let id = $(this).data('id');
            let url = "<?php echo e(route('superAdmin.biller.unpublish', ':id')); ?>";
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('superAdmin.biller')); ?>",
                    data: function(d) {
            ...
            $('#submit-all').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('superAdmin.biller.store')); ?>",
                    type: "POST",
            ...
            $('body').on('click', '.editPost', function() {
                ...
                var url = "<?php echo e(route('superAdmin.biller.update', ':id')); ?>";
            ...
            $('body').on('click', '.deletebiller', function(e) {
                ...
                var url = "<?php echo e(route('superAdmin.biller.deleted', ':id')); ?>";
                var catUrl = url.replace(':id', id);
...
<?php /**PATH F:\xampp74\htdocs\demoshop\resources\views/components/backend/superAdmin/biller/index.blade.php ENDPATH**/ ?>