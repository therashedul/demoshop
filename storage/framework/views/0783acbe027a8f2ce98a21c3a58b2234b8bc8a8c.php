...
<script type="text/javascript">
    ...
    $(document).on('click', '.publish', function(e) {
        ...
        var url = "<?php echo e(route('superAdmin.products.publish', ':id')); ?>";
    ...
    $(document).on('click', '.unpublish', function(e) {
        e.preventDefault();
        let id = $(this).data('id');
        let url = "<?php echo e(route('superAdmin.products.unpublish', ':id')); ?>";
...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('.data-table').DataTable({
            ...
            // serverSide: true,
            // ajax: {
            //     url: "<?php echo e(route('superAdmin.products')); ?>",
            // },
            // columns: [{
            //         data: 'DT_RowIndex',
            //         name: 'DT_RowIndex'
        ...
        $('.btnchange').change(function() {
           ...
           $('body').on('click', '.deleteproducts', function(e) {
                ...
                var url = "<?php echo e(route('superAdmin.products.deleted', ':id')); ?>";
...
<?php /**PATH F:\xampp74\htdocs\demoshop\resources\views/components/backend/superAdmin/product/productIndex.blade.php ENDPATH**/ ?>