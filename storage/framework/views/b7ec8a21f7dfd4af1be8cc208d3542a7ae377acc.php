    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('superAdmin.courier')); ?>",
                    data: function(d) {
            ...
            $('#submit-all').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('superAdmin.courier.store')); ?>",
                    type: "POST",
            ...
            $('body').on('click', '.editPost', function() {
                ...
                var url = "<?php echo e(route('superAdmin.courier.update', ':id')); ?>";
            ...
            $('body').on('click', '.deletecourier', function(e) {
                ...
                var url = "<?php echo e(route('superAdmin.courier.deleted', ':id')); ?>";
                var catUrl = url.replace(':id', id);
    ...
    </script><?php /**PATH F:\xampp74\htdocs\demoshop\resources\views/components/backend/superAdmin/courier/index.blade.php ENDPATH**/ ?>