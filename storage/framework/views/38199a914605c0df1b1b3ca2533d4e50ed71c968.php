<link rel="preload" href="<?php echo e(asset('css/daterangepicker.min.css')); ?>" as="style"
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item"> <a class="nav-link"
                                href="<?php echo e(route('superAdmin.expense_categories')); ?>">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item"> <a class="nav-link"
                                href="<?php echo e(route('superAdmin.accounts.balancesheet')); ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Balancesheet</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li><a href="#report" aria-expanded="false" data-toggle="collapse"> <i
                                    class="dripicons-document-remove"></i><span><?php echo e(trans('Reports')); ?></span></a>
                            <ul id="report" class="collapse list-unstyled ">
                                <li id="profit-loss-report-menu">
                                    <?php echo Form::open([
                                        'route' => 'superAdmin.report.profitLoss',
                                        'method' => 'post',
                                        'id' => 'profitLoss-report-form',
                                    ]); ?>
                                    ...
                                    <button id="profitLossLink"
                                        href=""><?php echo e(trans('Summary Reporting')); ?></button>
                                    <?php echo Form::close(); ?>
                                ...
                                <li id="daily-sale-report-menu">
                                    <a
                                        href="<?php echo e(url('superAdmin/report/daily_sale/' . date('Y') . '/' . date('m'))); ?>"><?php echo e(trans('Daily Sale')); ?></a>
                                </li>
                                <li id="monthly-sale-report-menu">
                                    <a
                                        href="<?php echo e(url('superAdmin/report/monthly_sale/' . date('Y'))); ?>"><?php echo e(trans('Monthly Sale')); ?></a>
                                </li>
                                <li id="best-seller-report-menu">
                                    <a
                                        href="<?php echo e(url('superAdmin/report/best_seller')); ?>"><?php echo e(trans('Best Seller')); ?></a>
                                </li>
                                <li id="daily-purchase-report-menu">
                                    <a
                                        href="<?php echo e(url('superAdmin/report/daily_purchase/' . date('Y') . '/' . date('m'))); ?>"><?php echo e(trans('Daily Purchase')); ?></a>
                                </li>

                                <li id="monthly-purchase-report-menu">
                                    <a
                                        href="<?php echo e(url('superAdmin/report/monthly_purchase/' . date('Y'))); ?>"><?php echo e(trans('Monthly Purchase')); ?></a>
                                </li>
                                ...
                                <li id="sale-report-chart-menu">
                                    ...
                                    <button id="sale-report-chart-link"
                                        href=""><?php echo e(trans('Sale Report Chart')); ?></button>
                                    <?php echo Form::close(); ?>
                                ...
                                <li id="payment-report-menu">
                                    <?php echo Form::open([
                                        'route' => 'superAdmin.report.paymentByDate',
                                        'method' => 'post',
                                    ...
                                    <input type="hidden" name="start_date" value="<?php echo e(date('Y-m') . '-' . '01'); ?>" />
                                    <input type="hidden" name="end_date" value="<?php echo e(date('Y-m-d')); ?>" />
                                    <button id="payment-report-link"
                                        href=""><?php echo e(trans('Payment Report')); ?></button>
                                    <?php echo Form::close(); ?>
                                ...
                                <li id="purchase-report-menu">
                                    ...
                                    <input type="hidden" name="end_date" value="<?php echo e(date('Y-m-d')); ?>" />
                                    <input type="hidden" name="warehouse_id" value="0" />
                                    <button id="purchase-report-link"
                                        href=""><?php echo e(trans('Purchase Report')); ?></button>
                                    <?php echo Form::close(); ?>
                                ...
                                <li id="due-report-menu">
                                    <?php echo Form::open([
                                        'route' => 'superAdmin.report.customerDueByDate',
                                        'method' => 'post',
                                        'id' => 'customer-due-report-form',
                                    ]); ?>

                                    <input type="hidden" name="start_date"
                                        value="<?php echo e(date('Y-m-d', strtotime('-1 year'))); ?>" />
                                    <input type="hidden" name="end_date" value="<?php echo e(date('Y-m-d')); ?>" />
                                    <button id="due-report-link"
                                        href=""><?php echo e(trans('Customer Due Report')); ?></button>
                                    <?php echo Form::close(); ?>
                                ...
                                <li id="supplier-due-report-menu">
                                    <?php echo Form::open([
                                        'route' => 'superAdmin.report.supplierDueByDate',
                                        'method' => 'post',
                                        'id' => 'supplier-due-report-form',
                                    ]); ?>

                                    <input type="hidden" name="start_date"
                                        value="<?php echo e(date('Y-m-d', strtotime('-1 year'))); ?>" />
                                    <input type="hidden" name="end_date" value="<?php echo e(date('Y-m-d')); ?>" />
                                    <button id="supplier-due-report-link"
                                        href=""><?php echo e(trans('Supplier Due Report')); ?></button>
                                    <?php echo Form::close(); ?>
                                ...
                                <li id="warehouse-stock-report-menu">
                                    <a
                                        href="<?php echo e(route('superAdmin.report.warehouseStock')); ?>"><?php echo e(trans('Warehouse Stock Chart')); ?></a>
                                </li>
                                <li id="productExpiry-report-menu">
                                    <a
                                        href="<?php echo e(route('superAdmin.report.productExpiry')); ?>"><?php echo e(trans('Product Expiry Report')); ?></a>
                                </li>
                                <li id="qtyAlert-report-menu">
                                    <a
                                        href="<?php echo e(route('superAdmin.report.qtyAlert')); ?>"><?php echo e(trans('Product Quantity Alert')); ?></a>
                                </li>
                                <li id="daily-sale-objective-menu">
                                    <button
                                        href="<?php echo e(route('superAdmin.report.dailySaleObjective')); ?>"><?php echo e(trans('Daily Sale Objective Report')); ?></button>
                                </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item"> <a class="nav-link"
                                href="<?php echo e(route('superAdmin.rewardPointSetting')); ?>">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('superAdmin.possetting')); ?>">
                          ...
                          <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('superAdmin.ganeralsetting.sms')); ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>SMS Setting</p>
                            </a>
                        </li>
                          <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('superAdmin.ganeralsetting.createSms')); ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Send SMS</p>
                            </a>
                        </li>
                            <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('superAdmin.ganeralsetting.superadminsetting')); ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Super admin  Setting</p>
                            </a>
                        </li>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('superAdmin.ganeralsetting.backup')); ?>">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Database back up</p>
                        </a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('superAdmin.custom-fields')); ?>">
                            <i class="far fa-circle nav-icon"></i>
                            <p>custom fields</p>
                        </a>
                    </li>
                            ...
                            <select name="expense_category_id" class="selectpicker form-control" required
                                ...
                                <?php $__currentLoopData = $lims_expense_category_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($expense_category->id); ?>">
                                        <?php echo e($expense_category->name . ' (' . $expense_category->code . ')'); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="col-md-6 form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="user_id" class="selectpicker form-control" required data-live-search="true"
                            ...
                            <?php $__currentLoopData = $lims_user_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($user->id); ?>"><?php echo e($user->name . ' (' . $user->mobile . ')'); ?>
...
<div id="account-statement-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="italic">
                    <small><?php echo e(trans('The field labels marked with * are required input fields')); ?>.</small></p>
                <?php echo Form::open(['route' => 'superAdmin.accounts.statement', 'method' => 'post']); ?>
...
<?php /**PATH F:\xampp74\htdocs\demoshop\resources\views/asset/nav.blade.php ENDPATH**/ ?>