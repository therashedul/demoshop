    ...
    <div class="container px-4">
        <div class="row">
            ...
            <div class="col-md-2 mt-4">
                <a class="btn btn-info mb-2 submitOnImage" href="javascript:void(0)" id="createNewcustomer">
                    Add New customer</a>
            </div>
        </div>
        <div class="row">
    ...
    <div class="modal  fade" id="ajaxModelexa" tabindex="-1" aria-labelledby="addcustomerModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable customer-modal">
            <form method="POST" action="<?php echo e(route('superAdmin.customer.store')); ?>" enctype="multipart/form-data"
                    style="width: 100%;">
            
                <?php echo csrf_field(); ?>
                <input type="hidden" name="id" id="id" class="id">
                <input type="hidden" name="user_id" id="uid" class="uid">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p id="res_bn"></p>
                        <div class="form-group">
                            <label class="col-form-label col-md-12 col-sm-12 label-align">Group name
                                <span class="required">*</span>
                            </label>
                            <div class="col-md-12 col-sm-12 ">
                                <select class="form-control up-gcustomer gcustomerName upgCustomer" id="gcustomerName"
                                    name="customer_group_id">
                                    <option value="0">Choose...</option>
                                    <?php $__currentLoopData = $limscustomergroupall; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="form-group">
                            <label class="col-form-label col-md-12 col-sm-12 label-align">customer Name
                                <span class="required">*</span>
                            </label>
                            <div class="col-md-12 col-sm-12 ">
                                <input type="text" name="customer_name" id="mySelect_name"
                                    class="form-control up_customer_name customerName mySelect_name" required />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-form-label col-md-12 col-sm-12 label-align"> Tax number

                            </label>
                            <div class="col-md-12 col-sm-12 ">
                                <input type="text" name="tax_number" id="tax_number"
                                    class="form-control up_tax_number tax_number" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 ">
                                <input type="textarea" name="address" id="address"
                                    class="form-control up_address address" required />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 pt-2 ">
                                <input type="checkbox" class="js-switch mycheckbox status" id="status"
                                    name="status" value="<?php echo e(1 ?? 0); ?>">
                            </div>
                        </div>

                        
                        <div class="form-group" id="imageUpload">
                            <label class="col-form-label col-md-12 col-sm-12 label-align">customer
                            ...
                            <div class="col-md-12 col-sm-12  text-center">
                                ...
                                <div id="post_select_image_container" class="post-select-image-container imageOn"
                                    ...
                                    <a href="" type="text" class="upload-text" data-toggle="modal"
                                        data-target="#image_file_manager">
                                        <img src="<?php echo e(asset('img/profile/cemera.jpg')); ?>" class="img-responsive  img-fluid"
                                            alt="" title="">
                                    </a>
                                </div>
                    ...
                    <div class="file-manager">
                        <div class="file-manager-left">
                            <form id="dropzoneForm" enctype="multipart/form-data" class="dropzone"
                                action="<?php echo e(route('superAdmin.category.upload')); ?>">
                                <?php echo csrf_field(); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.publish', function(e) {
            ...
            var url = "<?php echo e(route('superAdmin.customer.publish', ':id')); ?>";
        ...
        $(document).on('click', '.unpublish', function(e) {
            e.preventDefault();
            let id = $(this).data('id');
            let url = "<?php echo e(route('superAdmin.customer.unpublish', ':id')); ?>";
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('superAdmin.customer')); ?>",
                    data: function(d) {
            ...
            $('#submit-all').click(function(e) {
                ...
                let customerGroupName = $('.gcustomerName').val();
                let email = $('.email').val();
                let phone_number = $('.phone_number').val();
                let companyName = $('.company_name').val();
                let tax_no = $('.tax_number').val();
                ...
                let dataall = {
                    ...
                    'customer_group_id': customerGroupName,
                    'image': imageName,
                    'email': email,
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('superAdmin.customer.store')); ?>",
                    type: "POST",
            ...
            $('body').on('click', '.editPost', function() {
                ...
                var url = "<?php echo e(route('superAdmin.customer.update', ':id')); ?>";
                var catUrl = url.replace(':id', id);
                // alert(catUrl);

                let name = $(this).data('name');
                let customer_group_id = $(this).data('customer_group_id');
                let user_id = $(this).data('user_id');
                let address = $(this).data('address');
                let company_name = $(this).data('company_name');
                let tax_no = $(this).data('tax_number');
                ...
                $('#gcustomerName').val(customer_group_id);
                $('#uid').val(user_id);           
                $('#address').val(address);
                $('#companyName').val(company_name);
                $('#tax_number').val(tax_no);
                $('#email').val(email);
                ...
                let imageURL = <?php echo json_encode(url('/')); ?> + "/upload/";
                let emptyimageURL = <?php echo json_encode(url('/')); ?> + "/img/profile/cemera.jpg";
                if (image) {
            ...
            $('#up-submitbtn').click(function(e) {
                ...
                let customerName = $('.customerName').val();
                let user_id = $('.uid').val();
                let gcustomerName = $('.gcustomerName').val();
                let email = $('.email').val();
                let phone_number = $('.phone_number').val();
                let companyName = $('.company_name').val();
                let tax_no = $('.tax_number').val();
                ...
                let updateData = {
                    ...
                    'id': id,
                    'customer_name': customerName,
                    'customer_group_id': gcustomerName,
                    'user_id': user_id,
                    'image': imageName,
                    'email': email,
                    'phone_number': phone_number,
            ...
            $('body').on('click', '.deletecustomer', function(e) {
                ...
                var url = "<?php echo e(route('superAdmin.customer.deleted', ':id')); ?>";
                var catUrl = url.replace(':id', id);
...
<?php /**PATH F:\xampp74\htdocs\demoshop\resources\views/components/backend/superAdmin/customer/index.blade.php ENDPATH**/ ?>