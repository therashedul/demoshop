<?php $__env->startSection('content'); ?>
    ...
    <div class="container px-4">
        <div class="row">
            ...
            <div class="col-md-2 mt-4">
                <a class="btn btn-info mb-2 submitOnImage" href="javascript:void(0)" id="createNewsupplier">
                    Add New Supplier</a>
            </div>
        </div>
        <div class="row">
    ...
    <div class="modal  fade" id="ajaxModelexa" tabindex="-1" aria-labelledby="addsupplierModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable supplier-modal">
            ...
            <form style="width: 100%;" id="postForm" name="postForm" class="form-horizontal getUrl">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p id="res_bn"></p>
                        <div class="form-group">
                            <label class="col-form-label col-md-12 col-sm-12 label-align">Supplier Name
                                <span class="required">*</span>
                            </label>
                            <div class="col-md-12 col-sm-12 ">
                                <input type="text" name="supplier_name" id="mySelect_name"
                                    class="form-control up_supplier_name supplierName mySelect_name" required />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group" id="imageUpload">
                            <label class="col-form-label col-md-12 col-sm-12 label-align">supplier
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.publish', function(e) {
            ...
            var url = "<?php echo e(route('superAdmin.supplier.publish', ':id')); ?>";
        ...
        $(document).on('click', '.unpublish', function(e) {
            e.preventDefault();
            let id = $(this).data('id');
            let url = "<?php echo e(route('superAdmin.supplier.unpublish', ':id')); ?>";
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('superAdmin.supplier')); ?>",
                    data: function(d) {
            ...
            $('#submit-all').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('superAdmin.supplier.store')); ?>",
                    type: "POST",
            ...
            $('body').on('click', '.editPost', function() {
                ...
                var url = "<?php echo e(route('superAdmin.supplier.update', ':id')); ?>";
            ...
            $('body').on('click', '.deletesupplier', function(e) {
                ...
                var url = "<?php echo e(route('superAdmin.supplier.deleted', ':id')); ?>";
                var catUrl = url.replace(':id', id);
...
<?php echo $__env->make('layouts.deshboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp74\htdocs\demoshop\resources\views/superadmin/supplier/index.blade.php ENDPATH**/ ?>