                                            ...
                                            <form action="<?php echo e(route('superAdmin.products.update')); ?>" method="POST"
                                                ...
                                                <?php echo csrf_field(); ?>
                                                    ...
                                                    <input type="hidden" name="id"
                                                        value="<?php echo e($lims_product_data->id); ?>" />
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="hidden" name="type_hidden"
                                                                        value="<?php echo e($lims_product_data->product_type); ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="name"
                                                                    value="<?php echo e($lims_product_data->product_name); ?>"
                                                            ...
                                                            <input type="hidden" name="slug" id="slugValue"
                                                                ...
                                                                value="<?php echo e($lims_product_data->slug); ?>" />
                                                            <script type="text/javascript">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" name="product_code"
                                                                        value="<?php echo e($lims_product_data->product_code); ?>"
                                                        ...
                                                        <div id="combo" class="col-md-9 mb-1">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table id="myTable"
                                                                    ...
                                                                    <tbody>
                                                                        <?php if($lims_product_data->product_type == 'combo'): ?>
                                                                            <?php
                                                                                    ...
                                                                                    <?php
                                                                                        ...
                                                                                        if ($lims_product_data->variant_list && $variant_list[$key]) {
                                                                                            $product_variant_data = App\Models\ProductVariant::select('item_code')
                                                                                                ...
                                                                                                ->first();
                                                                                            $product->product_code = $product_variant_data->item_code;
                                                                                        } else {
                                                                                            $variant_list[$key] = '';
                                                                                        }
                                                                                    ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <input type="hidden" name="brand"
                                                                    value="<?php echo e($lims_product_data->brand_id); ?>">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <input type="hidden" name="category"
                                                                    value="<?php echo e($lims_product_data->category_id); ?>">
                                                        ...
                                                        <div id="cost" class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number"
                                                                    value="<?php echo e($lims_product_data->product_cost); ?>"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number"
                                                                    value="<?php echo e($lims_product_data->product_price); ?>"
                                                        ...
                                                        <div id="alert-qty" class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="alert_qty"
                                                                    value="<?php echo e($lims_product_data->alert_qty); ?>"
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="hidden" name="unit"
                                                                            value="<?php echo e($lims_product_data->unit_id); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="hidden" name="sale_unit"
                                                                            value="<?php echo e($lims_product_data->sale_unit_id); ?>">
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="hidden" name="purchase_unit"
                                                                                value="<?php echo e($lims_product_data->purchase_unit_id); ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="hidden" name="tax"
                                                                    value="<?php echo e($lims_product_data->tax_id); ?>">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <input type="hidden" name="tax_method_id"
                                                                    value="<?php echo e($lims_product_data->tax_method); ?>">
                                                                <label><?php echo e(trans('Tax Method')); ?></strong> </label>
                                                                <select name="tax_method"
                                                                    class="form-control selectpicker">

                                                                    <?php if($lims_product_data->tax_method == '1'): ?>
                                                        ...
                                                        <div id="regular_price" class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="product_regular_price"
                                                                    value="<?php echo e($lims_product_data->product_regular_price); ?>"
                                                                    class="form-control" step="any">
                                                            </div>
                                                        </div>
                                                        <div id="sell_price" class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="product_sell_price"
                                                                    value="<?php echo e($lims_product_data->product_sell_price); ?>"
                                                                    class="form-control" step="any">
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="col-md-6 form-group col-sm-6">
                                                                    <div class="x_content" id="">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <?php if(!empty($lims_product_data->product_image)): ?>
                                                                                <div id="post_select_image_container"
                                                                                    class="post-select-image-container">
                                                                                    <?php if($lims_product_data->product_image != null): ?>
                                                                                    ...
                                                                                    <?php endif; ?>
                                                                                    <img src="<?php echo e(asset('images/' . $lims_product_data->product_image)); ?>"
                                                                            ...
                                                                            <input type="hidden" name="image_name"
                                                                                id="image_name"
                                                                                value="<?php echo e($lims_product_data->product_image); ?>">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <?php echo e(str_replace('@', '"', $lims_product_data->product_details)); ?></textarea>
                                                        ...
                                                        <div class="col-md-12">
                                                            <h5>
                                                                <input type="hidden" value="0"
                                                                    ...
                                                                    <?php echo e($lims_product_data->is_active == 0 ? 'checked' : ''); ?>>
                                                                <input type="checkbox" value="1"
                                                                    class="js-switch" name="status"
                                                                    <?php echo e($lims_product_data->is_active == 1 ? 'checked' : ''); ?>>
                                                                &nbsp;
                                                                Status
                                                            </h5>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <h5>
                                                                <input type="hidden" value="0"
                                                                    ...
                                                                    <?php echo e($lims_product_data->trending == 0 ? 'checked' : ''); ?>>
                                                                <input type="checkbox" value="1"
                                                                    class="js-switch" name="trending"
                                                                    <?php echo e($lims_product_data->trending == 1 ? 'checked' : ''); ?>>
                                                                &nbsp;
                                                                Tranding
                                                            </h5>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12" id="variant-section">
                                                            <?php if($lims_product_data->variant_option): ?>
                                                                <div class="row" id="variant-input-section">
                                                                    <?php $__currentLoopData = $lims_product_data->variant_option; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $variant_option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php
                                                                        ...
                                                                        <div class="col-md-4 form-group mt-2">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                value="<?php echo e($lims_product_data->variant_option[$key]); ?>">
                                                                        </div>
                                                                        <div class="col-md-6 form-group mt-2">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                value="<?php echo e($lims_product_data->variant_value[$key]); ?>">
                                                                        </div>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </div>
                                                            <?php endif; ?>
                                                        ...
                                                        <div class="col-md-12 mt-2" id="diffPrice-option">
                                                            <?php if($lims_product_data->is_diffPriceWareHouse): ?>
                                                                    ...
                                                                    <thead>
                                                                        ...
                                                                        <?php $__currentLoopData = $lims_warehouse_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <tr>
                                                                                ...
                                                                                <?php
                                                                                    $product_warehouse = \App\Models\ProductWarehouse::FindProductWithoutVariant($lims_product_data->id, $warehouse->id)->first();
                                                                                ?>
                                                                                <td>
                                                        ...
                                                        <div class="col-md-4 mt-3">
                                                            <input type="hidden" name="promotion_hidden"
                                                                value="<?php echo e($lims_product_data->promotion); ?>">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4" id="promotion_price">
                                                                    ...
                                                                    <input type="number" name="promotion_price"
                                                                        value="<?php echo e($lims_product_data->promotion_price); ?>"
                                                                        class="form-control" step="any" />
                                                                </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" name="start_date"
                                                                                value="<?php echo e($lims_product_data->start_date); ?>"
                                                                                id="starting_date"
                                                                                class="form-control" />
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" name="last_date"
                                                                                value="<?php echo e($lims_product_data->end_date); ?>"
                                                                                id="last_date"
                                                                                class="form-control" />
                                                                        </div>
                                                                    </div>
...
<?php /**PATH F:\xampp74\htdocs\demoshop\resources\views/superadmin/product/edit.blade.php ENDPATH**/ ?>