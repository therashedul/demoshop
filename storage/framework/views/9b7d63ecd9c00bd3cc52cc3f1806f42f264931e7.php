<?php $__env->startSection('content'); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.publish', function(e) {
            ...
            var url = "<?php echo e(route('superAdmin.unit.publish', ':id')); ?>";
        ...
        $(document).on('click', '.unpublish', function(e) {
            e.preventDefault();
            let id = $(this).data('id');
            let url = "<?php echo e(route('superAdmin.unit.unpublish', ':id')); ?>";
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('superAdmin.unit')); ?>",
                    data: function(d) {
            ...
            $('#submit-all').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('superAdmin.unit.store')); ?>",
                    type: "POST",
            ...
            $('body').on('click', '.deleteunit', function(e) {
                ...
                var url = "<?php echo e(route('superAdmin.unit.deleted', ':id')); ?>";
...
<?php echo $__env->make('layouts.deshboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp74\htdocs\demoshop\resources\views/superadmin/unit/index.blade.php ENDPATH**/ ?>