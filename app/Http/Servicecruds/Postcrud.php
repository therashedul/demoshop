...
class Postcrud
{
    ...
    {
    //   $time = $request->input('publish_at') ? $request->input('publish_at'): date('Y-m-d H:i:s');
    //     print_r($request->all());
    //             die();
        $check = '';
        ...
        if ($request->method() == 'POST') {
            ...
            $postdate->publish_at =  $request->input('publish_at') ? $request->input('publish_at'): date('Y-m-d H:i:s'); 
        ...
        // Carbon::createFromFormat('Y-m-d H:i:s', $request->input('publish_at'))->format('Y-m-d H:i:s');
        // die();
