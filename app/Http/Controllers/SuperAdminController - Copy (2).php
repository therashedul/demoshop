...
class SuperAdminController extends Controller
{
    ...
    {
        return (new Salecrud)->saleData($request);
    ...
    {
        return (new Salecrud)->paypalSuccess( $request);
    ...
    {
        return (new Salecrud)->paypalPaymentSuccess( $request, $id); 
    ...
    {
        return (new Salecrud)->productSaleData($id); 
    ...
    {
        return (new Salecrud)->saleByCsv();  
    }

    public function importSale(Request $request)
    {
        return (new Salecrud)->importSale($request);  
    ...
    {
        return (new Productcrud)->productsdestroy($id);
