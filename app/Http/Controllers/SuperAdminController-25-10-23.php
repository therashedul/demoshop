            ...
            return Datatables::of($sales)
                ...
                ->addColumn('action', function ($row) {
                    if($row->sale_status != 3){
                        $updateButton = ' <a href="'.route('superAdmin.sale.edit', $row->id).'" class="btn btn-link"><i class="dripicons-document-edit"></i> '.trans('edit').'</a>';
                    }else{
                        $updateButton = '<a href="'.url('superAdmin/sale/'.$row->id.'/create').'" class="btn btn-link"><i class="dripicons-document-edit"></i> '.trans('edit').'</a>';
                    }
