            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => ['superAdmin.return-purchase.update', $lims_return_data->id], 'method' => 'put', 'files' => true, 'class' => 'payment-form']) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="supplier_id" class=" form-control" data-live-search="true" data-live-search-style="begins" title="Select supplier...">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required id="account_id" name="account_id" class=" form-control" data-live-search="true" data-live-search-style="begins" title="Select account...">
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    @endphp
                                                        <td>{{$product_data->product_name}} <button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"> <i class="dripicons-document-edit"></i></button> </td>
                                                        ...
                                                        <input type="hidden" class="purchase-unit" name="purchase_unit[]" value="{{$unit_code}}"/>
...
for(rowindex  =0; rowindex <= rownumber; rowindex++){
    ...
    temp_unit_code = $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.purchase-unit').val().split(',');
    ...
    $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.purchase-unit').val(temp_unit_code[0]);
}
...
var url = "{{ route('superAdmin.return-purchase.getproduct', ':id') }}";
...
function productSearch(data) {
    $.ajax({
        type: 'GET',
        url: "{{ route('superAdmin.return-purchase.lims_product_search') }}",
        data: {
            data: data
        },
