            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => ['superAdmin.return-sale.update', $lims_return_data->id], 'method' => 'put', 'files' => true, 'id' => 'payment-form']) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select required name="customer_id" class=" form-control" data-live-search="true" id="customer-id" data-live-search-style="begins" title="Select customer...">
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    // print_r($lims_product_return_data);
                                                    @endphp
                                                    ...
                                                    @php
                                                        ...
                                                        if($product_data->product_type == 'standard'){
                                                            $units = DB::table('units')->where('id', $product_data->unit_id)->orWhere('id', $product_data->unit_id)->get();
...
var url = "{{route('superAdmin.return-sale.getcustomergroup',':id')}}";
...
var url = "{{route('superAdmin.return-sale.getproduct',':id')}}";
var getUrl = url.replace(':id', id);
...
function isCashRegisterAvailable(warehouse_id) {
    ...
    $.ajax({
        url: getUrl,
        //  '../../cash-register/check-availability/'+warehouse_id,
        type: "GET",
...
function productSearch(data){
    var getUrl = "{{route('superAdmin.return-sale.lims_product_search')}}";
