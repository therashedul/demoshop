                                ...
                                <tr>
                                    ...
                                    <td>
                                                            ...
                                                            @if (stristr($name, 'user'))
                                                                ...
                                                                @if ($value == 'list')
                                                                    <a class="btn btn-secondary btn-sm"
                                                                        href="{{ route('superAdmin.users.show', $user->id) }}"><i
                                                                            class="fas fa-eye"></i></a>
                                                                @elseif ($value == 'create')
                                                                    {{-- <a class="btn btn-primary"
                                                                    href="{{ route('superAdmin.users.create') }}">New
                                                                    user</a> --}}
                                                                @elseif ($value == 'status')
                                                                    @if ($user->status_id == 1)
                                                                        <a href="{{ route('superAdmin.users.publish', $user->id) }}"
                                                                            class="btn btn-info btn-sm"><i
                                                                                class="fa fa-arrow-circle-up"
                                                                                aria-hidden="true"></i></a>
                                                                    @else
                                                                        <a href="{{ route('superAdmin.users.unpublish', $user->id) }}"
                                                                ...
                                                                @elseif ($value == 'edit')
                                                                    <a class="btn btn-primary btn-sm"
                                                                        href="{{ route('superAdmin.users.edit', $user->id) }}"><i
                                                                            class="fas fa-edit"></i></a>
                                                                @elseif ($value == 'delete')
                                                                    {!! Form::open([
                                                                        'method' => 'DELETE',
                                                                        'route' => ['superAdmin.users.destroy', $user->id],
                                        ...
                                        {{-- <a class="btn btn-success"
                                            href="{{ route('superAdmin.users.show', $user->id) }}">Show</a>
                                        <a class="btn btn-primary"
                                            href="{{ route('superAdmin.users.edit', $user->id) }}">Edit</a>
