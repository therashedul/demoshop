            ...
            <div class="card">
                <div class="card-header">Create User
                    <span class="float-right">
                        <a class="btn btn-primary" href="{{ route('superAdmin.users') }}">Users</a>
                    </span>
                </div>

                <div class="card-body">
                    {!! Form::open(['route' => 'superAdmin.users.store', 'method' => 'POST']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('mobile', null, ['placeholder' => 'Mobile No', 'class' => 'form-control']) !!}
                    </div>
                    <input type="hidden" value="1" name="is_email_verified">
                    <div class="form-group">
