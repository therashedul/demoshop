    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form action="{{ route('superAdmin.gallery.update', $singlegallery->id) }}" method="post"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input type="text" name="imagecaption" value="{{ $singlegallery->imagecaption }}"
                                    class="form-control">
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <select class="custom-select" name="category_id">
                                    @foreach ($categories as $category)
                                        <option {{ $category->id == $singlegallery->category_id ? 'selected=""' : '' }}
                                            value="{{ $category->id }}">
                        ...
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Popup

                            </label>
                            <div class="col-md-6 col-sm-6 ">
                                <label>
                                    <label>
                                        <input type="hidden" value="0" class="js-switch" name="popup"
                                            {{ $singlegallery->popup == 0 ? 'checked' : '' }}>
                                        <input type="checkbox" value="1" class="js-switch" name="popup"
                                            {{ $singlegallery->popup == 1 ? 'checked' : '' }}>
                                    </label>
                                </label>
                        ...
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">partnar

                            </label>
                            <div class="col-md-6 col-sm-6 ">
                                <label>
                                    <label>
                                        <input type="hidden" value="0" class="js-switch" name="partnar"
                                            {{ $singlegallery->partnar == 0 ? 'checked' : '' }}>
                                        <input type="checkbox" value="1" class="js-switch" name="partnar"
                                            {{ $singlegallery->partnar == 1 ? 'checked' : '' }}>
                                    </label>
                                </label>
                                ...
                                <label>
                                    <label>
                                        <input type="hidden" value="0" class="js-switch" name="status"
                                            {{ $singlegallery->status == 0 ? 'checked' : '' }}>
                                        <input type="checkbox" value="1" class="js-switch" name="status"
                                            {{ $singlegallery->status == 1 ? 'checked' : '' }}>
                                    </label>
                                </label>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                ...
                                @if (!empty($singlegallery->imagename))
                                    <div id="post_select_image_container" class="post-select-image-container">
                                        @if ($singlegallery->imagename != null)
                                            <button class="pull-right mt-4" onclick="displayimageRemove()" id="btn_delete">
                                                <i class="fa fa-times"></i>
                                            </button>
                                        @endif
                                        <img src="{{ asset('images/' . $singlegallery->imagename) }}"
                                            id="selected_image_file" alt="" width="80%" height="70%">
                                    </div>
                                @else
                                    <div id="post_select_image_container" class="post-select-image-container">
                                        <a href="" class="upload-text" type="text" data-toggle="modal"
