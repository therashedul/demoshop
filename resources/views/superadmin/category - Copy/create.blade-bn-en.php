                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="text" name="name_{{ $lang }}" class="form-control"
                                            id="mySelect_{{ $lang }}" onchange="{{ $lang }}_myFunction()"
                                            placeholder="category name" required="required" />

                                        <input type="hidden" name="title_{{ $lang }}" id="titleSelect"
                                            value="" class="form-control">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Slug
                                        Name {{ $lang }}
                                    </label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="text" name="slug_{{ $lang }}"
                                            id="slugValue_{{ $lang }}" value="" class="form-control"
                                            placeholder="Slug-name" required="required">
                                    </div>
                                    <input type="hidden" name="link_{{ $lang }}"
                                        id="linkValue_{{ $lang }}" value="" class="form-control">
                                </div>
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Select
                                        Parent
                                        Category {{ $lang }}<span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 ">
