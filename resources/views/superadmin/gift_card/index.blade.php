@extends('backend.layout.main') @section('content')
                            ...
                            @if ($gift_card->expired_date >= date('Y-m-d'))
                                <td>
                                    <div class="badge badge-success">
                                        {{ date('d-m-Y', strtotime($gift_card->expired_date)) }}</div>
                                </td>
                            @else
                                <td>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                        ...
                                        <li><button type="button" data-id="{{ $gift_card->id }}"
                                                class="recharge btn btn-link" data-toggle="modal"
                                                data-target="#rechargeModal"><i class="fa fa-money"></i>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button type="button"
                                    class="btn btn-default genbutton">{{ trans('file.Generate') }}</button>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <label>{{ trans('file.Card No') }} *</label>
                        <div class="input-group">
                            {{ Form::text('card_no_edit', null, ['required' => 'required', 'class' => 'form-control']) }}
                            <div class="input-group-append">
                                <button type="button"
                                    class="btn btn-default genbutton">{{ trans('file.Generate') }}</button>
                            </div>
                    ...
                    <div class="form-group customer_list_edit">
                        <label>{{ trans('file.customer') }} *</label>
                        <select name="customer_id_edit" class="selectpicker form-control" required
    ...
    <div id="rechargeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="exampleModalLabel" class="modal-title"> {{ trans('file.Card No') }}: <span
                            id="card-no"></span></h5>
                    <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span
                            aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.recharge', function() {
                ...
                var card_no = $('#gift_card-table tbody tr:nth-child(' + (rowindex + 1) + ')').find(
                    'td:nth-child(2)').text();
