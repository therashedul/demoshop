...
<body class="hold-transition sidebar-mini layout-fixed" onbeforeunload="MyFunction();">
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                @php
                                                    // print_r($lims_warehouse_list);
                                                @endphp
                                                {!! Form::open([
                                                    'route' => ['superAdmin.purchase.update', $lims_purchase_data->id],
                                                    'method' => 'put',
                                                    'files' => true,
                                                    'id' => 'purchase-form',
                                                ]) !!}
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="created_at"
                                                                        ...
                                                                        value="{{ date('d-m-Y', strtotime($lims_purchase_data->created_at)) }}" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label>{{ trans('Reference No') }}</label>
                                                                    <p><strong>{{ $lims_purchase_data->reference_no }}</strong>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="hidden" name="status_hidden"
                                                                        value="{{ $lims_purchase_data->purchase_status }}">
                                                                                    ...
                                                                                    @php
                                                                                        ...
                                                                                        foreach ($units as $unit) {
                                                                                            if ($product_purchase->purchase_unit_id == $unit->id) {
                                                                                                array_unshift($unit_name, $unit->unit_code);
    ...
    <script type="text/javascript">
        ...
        //     "6952897986810|Mouse", "72782608|mango", "85415108|Earphone", "38314290|lychee", "31261512|Baby doll",
        //     "212132|potato", "97103461|iphone-X", "72100265|Galaxy S9", "53467102|Polo Shirt", "90471412|Shoe",
        //     "859875003032|Toothpaste", "8941161008066|tissue", "32703342|TV", "41930312|Napa", "19243053|Denim Jeans",
        //     "32781116|dasdas", "2000004|Alpha Cheese", "S-93475396|T-shirt", "a-32081679|testvar",
        //     "variant 1-81145830|Test variant", "s/red-82490498|Cotton Punjabi", "red-17628500|Iphone 14",
        //     "s/white-91876421|Formal shirt", "M-93475396|T-shirt", "b-32081679|testvar",
        //     "variant 2-81145830|Test variant", "s/blue-82490498|Cotton Punjabi", "black-17628500|Iphone 14",
        //     "s/blue-91876421|Formal shirt", "L-93475396|T-shirt", "s/green-82490498|Cotton Punjabi",
        //     "blue-17628500|Iphone 14", "m/white-91876421|Formal shirt", "m/red-82490498|Cotton Punjabi",
        //     "m/blue-91876421|Formal shirt", "m/blue-82490498|Cotton Punjabi", "l/white-91876421|Formal shirt",
        //     "m/green-82490498|Cotton Punjabi", "l/blue-91876421|Formal shirt", "l/red-82490498|Cotton Punjabi",
        //     "l/blue-82490498|Cotton Punjabi", "l/green-82490498|Cotton Punjabi", "xl/red-82490498|Cotton Punjabi",
        //     "xl/blue-82490498|Cotton Punjabi", "xl/green-82490498|Cotton Punjabi"
        // ];
