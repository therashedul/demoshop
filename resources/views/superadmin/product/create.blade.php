...
<body class="hold-transition sidebar-mini layout-fixed" onbeforeunload="MyFunction();">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="{{ route('superAdmin.products.store') }}" method="POST"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>{{ trans('Product Code') }} *</strong> </label>
                                                            <div class="input-group">
                                                    ...
                                                    {{-- <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="quantity" id="mySelect_qty"
                                                                required class="form-control" step="any"
                                                                onchange="myFunction_qty()">
                                                            <span class="validation-msg"></span>
                                                        </div>
                                                        <script>
                                                    ...
                                                    <div id="alert-qty" class="col-md-4">
                                                        <div class="form-group">
                                                            <label>{{trans('Alert Quantity')}}</strong> </label>
                                                    ...
                                                    {{-- <div id="alert_qty" class="col-md-4">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>{{trans('Daily Sale Objective')}}</strong></label> <i class="dripicons-question" data-toggle="tooltip" title="{{trans('Minimum qty which must be sold in a day. If not, you will be notified on dashboard. But you have to set up the cron job properly for that. Follow the documentation in that regard.')}}"></i>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>{{ trans('Tax Method') }}</strong> </label> <i
                                                            ...
                                                            <select name="tax_method"
                                                                ...
                                                                <option value="1">{{ trans('Exclusive') }}
                                                                </option>
                                                                <option value="2">{{ trans('Inclusive') }}
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div id="unit" class="col-md-12">
                                                        <div class="row ">
                                                            ...
                                                            <div class="col-md-4">
                                                                <label>{{ trans('Sale Unit') }}</strong> </label>
                                                                <div class="input-group">
                                                                    <select required class="form-control "
                                                                        name="sale_unit_id">
                                                                        <option value="" disabled selected>Select
    ...
    lims_productcodeSearch.autocomplete({
        ...
        select: function(event, ui) {
            ...
            $.ajax({
                type: 'GET',
                url: "{{ route('superAdmin.products.lims_product_search') }}",
                data: {
                    data: data
                },
                success: function(data) {
...
{{-- //  <x-backend.superAdmin.product.productcreate 
// :limsunitlist="$lims_unit_list" 
