            <style>
                ...
                div#up_post_select_image_container {
                    width: 200px;
                    height: 250px;
                }

                .up-post-select-image-container img {
                    width: 100%;
                }
            ...
            <div class="modal  fade" id="addCategoryModal" tabindex="-1" aria-labelledby="addCategoryModalLabel"
                ...
                <div class="modal-dialog modal-dialog-scrollable category-modal">
                    ...
                    style="width: 100%;"> --}}
                    <form style="width: 100%;" id="category-form">
                        @csrf
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class=" form-group">
                                    <label class="col-form-label col-md-12 col-sm-12 label-align"
                                        for="last-name">Category Images </label>
                                ...
                                <div class="form-group ">
                                    <div class="col-md-12 col-sm-12 mb-3">
                                        <button type="submit"
                                            class="btn btn-outline-success btn-lg btn-block btnSubmit"
            ...
            <div class="modal fade" id="cateditModal" tabindex="-1" aria-labelledby="cateditModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable category-modal">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-sm-12 ">
                                        <input type="text" name="name_en" id="mySelect_en"
                                            onchange="myFunction_en()" class="form-control up_name_en nameEn"
                                            required />
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                if (res.status == 'success') {
                                    ...
                                    $('#btn_delete_post_main_image').css({
                                        "opacity : 0.0"
                                    });
            ...
            <script type="text/javascript">
                $('.nameEn').blur(function() {
                    ...
                    xhttp.onreadystatechange = function() {
                        // alert(this.responseText);
                        if (this.readyState == 4 && this.status == 200) {
                            document.getElementById("up_res_en").innerHTML =
                                this.responseText;
                            if (this.responseText == "Name already exist") {
                                $("#up_res_en").css({
                                    "color": "red",
                ...
                $('.nameBn').blur(function() {
                    var nameValue = $('.nameBn').val();
                    const xhttp = new XMLHttpRequest();
                    let serverUrl = '/categoryCheck.name/' + nameValue;
                    xhttp.open("GET", serverUrl);
                    xhttp.onreadystatechange = function() {
                        // alert(this.responseText);
                        if (this.readyState == 4 && this.status == 200) {
                            document.getElementById("up_res_bn").innerHTML =
                                this.responseText;
                            if (this.responseText == "Name already exist") {
                                $("#up_res_bn").css({
                                    "color": "red",
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    $(document).on('click', '.update-category', function(e) {
                        ...
                        if (image) {
                            let dispalyImg = '<div class="up-post-select-image-container">' +
