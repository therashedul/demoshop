                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="hidden" name="type_hidden"
                                                                        value="{{ $lims_product_data->product_type }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="name"
                                                                    value="{{ $lims_product_data->product_name }}"
                                                        ...
                                                        <div id="cost" class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number"
                                                                    value="{{ $lims_product_data->product_cost }}"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number"
                                                                    value="{{ $lims_product_data->product_price }}"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="tax_method"
                                                                    ...
                                                                    @if ($lims_product_data->tax_method == '1')
                                                        ...
                                                        <div id="regular_price" class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="product_regular_price"
                                                                    value="{{ $lims_product_data->product_regular_price }}"
                                                                    class="form-control" step="any">
                                                            </div>
                                                        </div>
                                                        <div id="sell_price" class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="product_sell_price"
                                                                    value="{{ $lims_product_data->product_sell_price }}"
                                                                    class="form-control" step="any">
                                                            </div>
                                                        </div>
                                                        {{-- ===================== --}}
                                                                ...
                                                                <div class="col-md-6 form-group col-sm-6">
                                                                    <div class="x_content" id="">
                                                                        <div class="form-group">
                                                                            ...
                                                                            @if (!empty($lims_product_data->product_image))
                                                                                <div id="post_select_image_container"
                                                                                    class="post-select-image-container">
                                                                                    @if ($lims_product_data->product_image != null)
                                                                                    ...
                                                                                    @endif
                                                                                    <img src="{{ asset('images/' . $lims_product_data->product_image) }}"
                                                                            ...
                                                                            <input type="hidden" name="image_name"
                                                                                id="image_name"
                                                                                value="{{ $lims_product_data->product_image }}">
                                                        ...
                                                        <div class="col-md-12">
                                                            <h5>
                                                                <input type="hidden" value="0"
                                                                    ...
                                                                    {{ $lims_product_data->is_active == 0 ? 'checked' : '' }}>
                                                                <input type="checkbox" value="1"
                                                                    class="js-switch" name="status"
                                                                    {{ $lims_product_data->is_active == 1 ? 'checked' : '' }}>
                                                                &nbsp;
                                                                Status
                                                            </h5>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <h5>
                                                                <input type="hidden" value="0"
                                                                    ...
                                                                    {{ $lims_product_data->trending == 0 ? 'checked' : '' }}>
                                                                <input type="checkbox" value="1"
                                                                    class="js-switch" name="trending"
                                                                    {{ $lims_product_data->trending == 1 ? 'checked' : '' }}>
                                                                &nbsp;
                                                                Tranding
                                                            </h5>
                                                        </div>
                                                                ...
                                                                <table id="variant-table"
                                                                    ...
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th>{{ trans('Additional Cost') }}
                                                                            </th>
                                                                            <th>{{ trans('Additional Price') }}
                                                                            </th>
                                                                            <th>{{ trans('Stock') }}
                                                                            </th>
                                                                        </tr>
                                                                        ...
                                                                        @foreach ($lims_product_variant_data as $key => $variant)
                                                                            <tr>
                                                                                ...
                                                                                <td><input type="number"
                                                                                        ...
                                                                                        step="any" /></td>
                                                                                <td><input type="number"
                                                                                        class="form-control additional-stock"
                                                                                        name="additional_stock[]"
                                                                                        value="{{ $variant->pivot['stock'] }}"
                                                                                        step="any" /></td>
                                                                            </tr>
                                                                        @endforeach
                                                                    </tbody>
                                                        ...
                                                        <div class="col-md-12 mt-2" id="diffPrice-option">
                                                            @if ($lims_product_data->is_diffPriceWareHouse)
                    ...
                    if (customizedVariantCode) {
                        ...
                        for (i = 0; i < combinations.length; i++) {
                            ...
                            if (oldIndex >= 0) {
                                ...
                                cols +=
                                    '<td><input type="number" class="form-control additional-stock" name="additional_stock[]" value="' +
                                ...
                                cols +=
                                    '<td><input type="number" class="form-control additional-stock" name="additional_stock[]" value="" step="any" /></td>';
                            }
                            newRow.append(cols);
