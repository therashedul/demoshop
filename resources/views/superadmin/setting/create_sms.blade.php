            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{trans('Create SMS')}}</h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small>{{trans('The field labels marked with * are required input fields')}}.<strong>{{trans('Add mobile numbers by selecting the customers')}}</strong></small></p>
                        {!! Form::open(['route' => 'superAdmin.ganeralsetting.sendSms', 'method' => 'post']) !!}
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary"><i class="fa fa-paper-plane"></i> {{trans('Send SMS')}}</button>
                                    </div>
                                </div>
                            </div>
                        {!! Form::close() !!}
