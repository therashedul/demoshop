            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{trans('General Setting')}}</h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small>{{trans('The field labels marked with * are required input fields')}}.</small></p>
                        {!! Form::open(['route' => 'superAdmin.ganeralsetting.store', 'files' => true, 'method' => 'post']) !!}
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if(!empty($lims_general_setting_data->company_name))
                                        <input type="text" name="company_name" class="form-control" value="{{$lims_general_setting_data->company_name}}" />
                                        @else
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="timezone_hidden" value="{{env('APP_TIMEZONE')}}">
                                        @endif
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if(!empty($lims_general_setting_data->developed_by))
                            ...
                            <div class="col-md-6 mt-4">
                                <div class="form-group">
                                    @if(!empty($lims_general_setting_data->is_rtl))
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @if(!empty($lims_general_setting_data->	vat_registration_number	))
                                        <input type="text" name="vat_registration_number" class="form-control" value="{{$lims_general_setting_data->	vat_registration_number	}}">
                                        @else
