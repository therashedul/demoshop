...
<section class="forms">
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">{{trans('User Report')}}</h3>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4 mt-3">
                    <div class="form-group row">
                        <label class="d-tc mt-2"><strong>{{trans('Choose User')}}</strong> &nbsp;</label>
                        <div class="d-tc">
    ...
    <ul class="nav nav-tabs ml-4 mt-3" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" href="#user-sale" role="tab" data-toggle="tab">{{trans('Sale')}}</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#user-purchase" role="tab" data-toggle="tab">{{trans('Purchase')}}</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#user-quotation" role="tab" data-toggle="tab">{{trans('Quotation')}}</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#user-transfer" role="tab" data-toggle="tab">{{trans('Transfer')}}</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#user-payments" role="tab" data-toggle="tab">{{trans('Payment')}}</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#user-expense" role="tab" data-toggle="tab">{{trans('Expense')}}</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#user-payroll" role="tab" data-toggle="tab">{{trans('Payroll')}}</a>
        </li>
    </ul>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if($purchase->status == 1)
                               <td><div class="badge badge-success">{{trans('Recieved')}}</div></td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php
                                    ...
                                    $unit = App\Models\Unit::find($product_quotation_data->quotation_unit_id);
                                ?>
                                @if($unit)
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php
                                    $product = App\Models\Product::find($product_transfer_data->product_id);
                                    if($product_transfer_data->variant_id) {
                                        $variant = App\Models\Variant::find($product_transfer_data->variant_id);
                                        $product->product_name .= ' ['.optional($variant)->variant_name.']';
                                    }
                                    $unit = App\Models\Unit::find($product_transfer_data->transfer_unit_id);
                                ?>
                                @if($unit)
                                    {{$product->product_name.' ('.$product_transfer_data->qty.' '.$unit->unit_code.')'}}
                                @else
                                    {{$product->product_name.' ('.$product_transfer_data->qty.')'}}
                                @endif
                                <br>
                                @endforeach
                            </td>
                            ...
                            <td><div class="badge badge-danger">{{trans('Pending')}}</div></td>
                            @else
                            <td><div class="badge badge-warning">{{trans('Sent')}}</div></td>
                            @endif
                        </tr>
                        @endforeach
                    </tbody>
