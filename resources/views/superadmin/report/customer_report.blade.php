...
<section class="forms">
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">{{trans('Customer Report')}}</h3>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4 mt-3">
                    <div class="form-group row">
                        <label class="d-tc mt-2"><strong>{{trans('Choose Customer')}}</strong> &nbsp;</label>
                        <div class="d-tc">
    ...
    <ul class="nav nav-tabs ml-4 mt-3" role="tablist">
      <li class="nav-item">
        <a class="nav-link active" href="#customer-sale" role="tab" data-toggle="tab">{{trans('Sale')}}</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#customer-payments" role="tab" data-toggle="tab">{{trans('Payment')}}</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#customer-quotation" role="tab" data-toggle="tab">{{trans('Quotation')}}</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#customer-return" role="tab" data-toggle="tab">{{trans('return')}}</a>
      </li>
    </ul>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                @if($unit)
                                    {{$product->product_name.' ('.$product_sale_data->qty.' '.$unit->unit_name.')'}}
                                @else
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                @if($unit)
                                    {{$product->product_name.' ('.$product_return_data->qty.' '.$unit->unit_name.')'}}
                                @else
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                @if($unit)
                                    {{$product->product_name.' ('.$product_quotation_data->qty.' '.$unit->unit_name.')'}}
                                @else
