...
{{-- {{ $general_setting->id }} --}}
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="custom-daterange " style="display: none; width:100%;">
                ...
                <div class="form-group col-md-3 ">
                    <div class="form-group">
                        <label><strong>Sale Stataus</strong></label>
                        <select id="sale_status" class="form-control sale_status" name="sale_status">
                                <option value="">All</option>
                                <option value="1">{{ trans('Completed') }}
                                </option>
                                <option value="2">{{ trans('Pending') }}
                                </option>
                                <option value="2">{{ trans('Draft') }}
                                </option>
                        </select>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select id="payment_status" class="form-control payment_status" name="payment_status">
                            <option value="">All</option>
                            <option value="1">{{ trans('Pending') }}
                            </option>
                            <option value="2">{{ trans('Due') }}
                            </option>
                            <option value="3">{{ trans('Partial') }}
                            </option>
                            <option value="4">{{ trans('Paid') }}
                            </option>
                        </select>
                    </div>
                </div>
                <div class="form-group col-md-12">
                    <h5> Search</h5>
                    <input type="text" name="reference_no" class="form-control searchEmail" placeholder="Search reference number...">
    ...
    <section>
        <div class="container-fluid px-4">
            ...
            <div class="row">
                ...
                <div class="col-md-3 justify-content-end add-search-btn pull-right float-right d-flex" style="padding-top: 0.5%">
                    <button type="button" class="btn btn-info searchBtn"><i class="fas fa-search-plus"></i> Search</button>
                    &nbsp;
                    <a href="{{ route('superAdmin.sale.create') }}" class="btn btn-success"><i class="dripicons-plus"></i>
                        {{ trans('Add Sale') }}</a>
                </div>
            </div>
        ...
        <script type="text/javascript">
            $('.searchBtn').click(function(e) {
                e.preventDefault();
                $('.add-search-btn').css('padding-top', '1%');
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-1">
                            ...
                            <select name="paid_by_id" class="form-control">
                                ...
                                @if(!empty($lims_reward_point_setting_data->is_active))
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label>Courier</label>
                            <select name="courier_id"  class="form-control upcourier" 
                            data-live-search="true" title="Select courier...">
                                @foreach ($lims_deliveres_list as $couriar)
...
@push('custom_scripts')
    <script type="text/javascript">
        ...
        @if(!empty($lims_pos_setting_data->stripe_public_key))
            ...
            ajax: {
              ...
              // ============================ Mulipol collam  sum =================================
                ...
                drawCallback: function(row, data, start, end, display) {
                    ...
                    // Update footer
                    $(api.column(9).footer()).html(Math.round(pageTotal) +" /=");
                    $(api.column(10).footer()).html(Math.round(pageTotalReturnAmount) +" /="  ); 
                    //.toFixed(2) for floting link:23.55 Taka
                    $(api.column(11).footer()).html( Math.round(pageTotalpaid) +" /=" );  
                    $(api.column(12).footer()).html( Math.round(pageTotaldue) +" /=" );
