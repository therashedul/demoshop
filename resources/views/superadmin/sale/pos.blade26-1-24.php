...
<nav class="side-navbar shrink">
    ...
    <ul id="side-main-menu" class="side-menu list-unstyled">
        ...
        <ul id="product" class="collapse list-unstyled ">
            <li id="category-menu"><a href="{{route('superAdmin.category')}}">{{__('file.category')}}</a></li>
            <li id="product-list-menu"><a href="{{route('superAdmin.products')}}">{{__('file.product_list')}}</a></li>

            <li id="product-create-menu"><a href="{{route('superAdmin.products.create')}}">{{__('file.add_product')}}</a></li>
        ...
        <ul id="purchase" class="collapse list-unstyled ">
            <li id="purchase-list-menu"><a href="{{route('superAdmin.purchase')}}">{{trans('file.Purchase List')}}</a></li>

            <li id="purchase-create-menu"><a href="{{route('superAdmin.purchase.create')}}">{{trans('file.Add Purchase')}}</a></li>
        ...
        <ul id="sale" class="collapse list-unstyled ">
            ...
            <li id="sale-list-menu"><a href="{{route('superAdmin.sale')}}">{{trans('file.Sale List')}}</a></li>


            <li><a href="{{route('sale.pos')}}">POS</a></li>
            <li id="sale-create-menu"><a href="{{route('superAdmin.sale.create')}}">{{trans('file.Add Sale')}}</a></li>
            {{-- <li id="sale-import-menu"><a href="{{url('sales/sale_by_csv')}}">{{trans('file.Import Sale By CSV')}}</a></li> --}}

            <li id="gift-card-menu"><a href="{{route('superAdmin.giftcard')}}">{{trans('file.Gift Card List')}}</a> </li>

            <li id="coupon-menu"><a href="{{route('superAdmin.coupons')}}">{{trans('file.Coupon List')}}</a> </li>

            <li id="delivery-menu"><a href="{{route('superAdmin.delivery')}}">{{trans('file.Delivery List')}}</a></li>
        </ul>
        </li>
        ...
        <ul id="account" class="collapse list-unstyled ">
            ...
            <li id="account-list-menu"><a href="{{route('superAdmin.accounts')}}">{{trans('file.Account List')}}</a></li>
