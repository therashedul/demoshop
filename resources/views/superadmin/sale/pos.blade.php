                          ...
                          <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                            <div class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                  ...
                                  <li class="dropdown-item"><a href="{{route('superAdmin.products.create')}}">{{__('file.add_product')}}</a></li>
                                  <li class="dropdown-item"><a href="{{route('superAdmin.purchase.create')}}">{{trans('file.Add Purchase')}}</a></li>
                                  <li class="dropdown-item"><a href="{{route('superAdmin.sale.create')}}">{{trans('file.Add Sale')}}</a></li>
                                ...
                                <li class="dropdown-item"><a href="{{route('superAdmin.transfers.create')}}">{{trans('file.Add Transfer')}}</a></li>
                                ...
                                <li class="dropdown-item"><a href="{{route('superAdmin.customer.create')}}">{{trans('file.Add Customer')}}</a></li>
                                <li class="dropdown-item"><a href="{{route('superAdmin.biller.create')}}">{{trans('file.Add Biller')}}</a></li>
                                <li class="dropdown-item"><a href="{{route('superAdmin.supplier.create')}}">{{trans('file.Add Supplier')}}</a></li>
                            ...
                            @endif --}}
                            <li class="nav-item"><a class="dropdown-item" data-toggle="tooltip" href="{{route('superAdmin.possetting')}}" title="{{trans('file.POS Setting')}}"><i class="dripicons-gear"></i></a> </li>
                            <li class="nav-item">
                                <a href="{{route('superAdmin.sale.printLastReciept')}}" data-toggle="tooltip" title="{{trans('file.Print Last Reciept')}}"><i class="dripicons-print"></i></a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="right-sidebar">
                                    ...
                                    <li>
                                        <a href="{{route('superAdmin.ganeralsetting')}}"><i class="dripicons-gear"></i> {{trans('file.settings')}}</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="{{url('superAdmin.holidays.myHoliday/'.date('Y').'/'.date('m'))}}"><i class="dripicons-vibrate"></i> {{trans('file.My Holiday')}}</a>
                                    </li>
                                    @endif
                                    <li>
                                        <a href="{{ route('logout') }}"
                    ...
                    <div class="col-md-12 mt-1 table-container">
                        <table id="product-table" class="table no-shadow product-list">
                            ...
                            @for ($i=0; $i < ceil($product_number/5); $i++)
                                <tr>
                                    <td class="product-img sound-btn" title="{{$lims_product_list[0+$i*5]->product_name}}" data-product ="{{$lims_product_list[0+$i*5]->product_code . ' (' . $lims_product_list[0+$i*5]->product_name . ')'}}"><img  src="{{url('thumbnail',$lims_product_list[0+$i*5]->base_image)}}" width="100%" />
                                        <p>{{$lims_product_list[0+$i*5]->product_name}}</p>
                                        <span>{{$lims_product_list[0+$i*5]->product_code}}</span>
                                    </td>
                                    @if(!empty($lims_product_list[1+$i*5]))
                                    <td class="product-img sound-btn" title="{{$lims_product_list[1+$i*5]->product_name}}" data-product ="{{$lims_product_list[1+$i*5]->product_code . ' (' . $lims_product_list[1+$i*5]->product_name . ')'}}"><img  src="{{url('thumbnail',$lims_product_list[1+$i*5]->base_image)}}" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="{{$lims_product_list[2+$i*5]->product_name}}" data-product ="{{$lims_product_list[2+$i*5]->product_code . ' (' . $lims_product_list[2+$i*5]->product_name . ')'}}"><img  src="{{url('thumbnail',$lims_product_list[2+$i*5]->base_image)}}" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="{{$lims_product_list[3+$i*5]->product_name}}" data-product ="{{$lims_product_list[3+$i*5]->product_code . ' (' . $lims_product_list[3+$i*5]->product_name . ')'}}"><img  src="{{url('thumbnail',$lims_product_list[3+$i*5]->base_image)}}" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="{{$lims_product_list[4+$i*5]->product_name}}" data-product ="{{$lims_product_list[4+$i*5]->product_code . ' (' . $lims_product_list[4+$i*5]->product_name . ')'}}"><img  src="{{url('thumbnail',$lims_product_list[4+$i*5]->base_image)}}" width="100%" />
...
<script type="text/javascript">
    ...
    @if(!empty($limspossettingdata->stripe_public_key))
...
var warehouse_id = @php echo json_encode(\Auth::user()->warehouse_id) @endphp;
var biller_id = @php echo json_encode(\Auth::user()->biller_id) @endphp;
...
$("#print-btn").on("click", function(){
      ...
      newWin.document.write('<link rel="stylesheet" href="@php echo asset('vendor/bootstrap/css/bootstrap.min.css') @endphp" type="text/css"><style type="text/css">@media print {.modal-dialog { max-width: 1000px;} }</style><body onload="window.print()">'+divToPrint.innerHTML+'</body>');
...
function giftCard() {
    $(".gift-card").show();
    getUrl = "{{route('superAdmin.sale.getGiftCard')}}";
    $.ajax({
        url: getUrl,
