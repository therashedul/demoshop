@extends('layouts.deshboard') @section('content')
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::open(['route' => ['superAdmin.discount.update', $lims_discount_data->id], 'method' => 'patch']) !!}
                            @csrf
                            <input type="hidden" name="id" value="{{ $lims_discount_data->id }}">
                            <div class="row">
                                <div class="col-md-3 form-group">
                                    <label>{{ trans('file.name') }} *</label>
                                    <input type="text" name="name" value="{{ $lims_discount_data->name }}" required
                                        class="form-control">
                                </div>
                                <div class="col-md-3 form-group">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <select required name="applicable_for" class="form-control">
                                        ...
                                        @else
                                            ...
                                            <option selected value="Specific">{{ trans('file.Specific Products') }}
                                            </option>
                                        @endif
                                    </select>
                                </div>
                                ...
                                <div class="col-md-9 form-group product-selection">
                                    ...
                                    <input type="text" name="product_code" id="product-code" class="form-control"
                                        placeholder="{{ trans('file.Type product code seperated by comma') }}">
                                </div>
                                <div class="col-md-9 form-group product-selection">
                                        ...
                                        <table id="product-table" class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>{{ trans('file.Product Item') }}</th>
                                                    <th><i class="dripicons-trash"></i>Delete</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @if ($lims_discount_data->applicable_for == 'Specific')
                                                    @php $product_ids = explode(',', $lims_discount_data->product_list); @endphp
                                                        ...
                                                        @php
                                                            ...
                                                            if ($product_data) {
                                                                $product_data = DB::table('products')
                                                                    ...
                                                                    ->select('product_variants.item_code', 'products.id', 'products.product_name', 'products.product_code')
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="date" name="valid_from"
                                        value="{{ date('Y-m-d', strtotime($lims_discount_data->valid_from)) }}" required
                                        class="form-control date">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>{{ trans('file.Valid Till') }} *</label>
                                    <input type="date" name="valid_till"
                                        value="{{ date('Y-m-d', strtotime($lims_discount_data->valid_till)) }}" required
                                        class="form-control date">
                                </div>
                                <div class="col-md-4 form-group">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="number" name="value" value="{{ $lims_discount_data->value }}" required
                                        class="form-control">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>{{ trans('file.Minimum Qty') }} *</label>
                                    <input type="number" name="minimum_qty" value="{{ $lims_discount_data->minimum_qty }}"
                                        required class="form-control">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>{{ trans('file.Maximum Qty') }} *</label>
                                    <input type="number" name="maximum_qty" value="{{ $lims_discount_data->maximum_qty }}"
                                        required class="form-control">
                                </div>
                                <div class="col-md-4 form-group">
    ...
    <script type="text/javascript">
        ...
        var discount_plan_ids = @php echo json_encode($discount_plan_ids); @endphp;
        var applicable_for = @php echo json_encode($lims_discount_data->applicable_for); @endphp;
        var days = @php echo json_encode(explode(',', $lims_discount_data->days)); @endphp;
        // console.log(days);
        for (i = 0; i < days.length; i++) {
            $("." + days[i]).prop('checked', true);
        }

        // var discount_plan_ids = [1];
