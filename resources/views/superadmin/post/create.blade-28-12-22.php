        ...
        <div class="justify-content-center">
            ...
            <div class="bootstrap-iso">
                <form method="POST" action="{{ route('superAdmin.post.store') }}" enctype="multipart/form-data">
                    {{-- {!! Form::open(['route' => 'superAdmin.post.store', 'method' => 'POST']) !!} --}}
                    @csrf
                                    ...
                                    @if ($categories)
                                        @foreach ($categories as $category)
                                            <div class="form-check checkbox">
                                                <label>
                                                    <input class="form-check-input parent flat " name="subcat_id[]"
                                                ...
                                                @foreach ($category->subcategory as $sub)
                                                    @if ($sub->parent_id)
                                                        <div class="form-check" style="margin:1% 0 3% 5%;">
                                                            <input class="form-check-input child flat"
                                                                style="px;margin-left: 7px;" name="subcat_id[]"
                                        ...
                                        <div class="form-group">
                                            <div class='input-group date'>
                                                <input type='text' id='datetimepicker' class="form-control"
                                                    name="publish_at" value="{{ date('Y-m-d H:i:s', time()) }}" />
                                            </div>
                                        </div>
                                        <script type="text/javascript">
                                            // var today = new Date();
