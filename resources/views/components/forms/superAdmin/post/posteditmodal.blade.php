...
<script type="text/javascript">
    ...
    $(document).on('click', '#image_file_manager .file-box', function() {
        ...
        let file_path = $(this).attr('data-file-path');
        let alt = $(this).attr('data-file-alt');
        let title = $(this).attr('data-file-title');
        let caption = $(this).attr('data-file-caption');
        let description = $(this).attr('data-file-description');
    ...
    $(document).on('click', '#image_file_manager #btn_img_delete', function() {
        let file_name = $('#selected_img_name').val();
        $.ajax({
    ...
    function select_image() {
        let file_name = $('#selected_img_name').val();
        let file_id = $('#selected_img_file_id').val();
        let img_url = $('#selected_img_file_path').val();

        let alt = $('#altText').val();
        let title = $('#titleText').val();
        let caption = $('#captionText').val();
        ...
        let image = '<div class="post-select-image-container">' +
