        ...
        <div class="custom-daterange " style="display: none">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    {{-- <input type="text" name="purchase_status" class="form-control purchase_status" id="purchase_status"> --}}
    ...
    <script type="text/javascript">
        ...
        // var startingdate = @php echo json_encode($startingdate); @endphp;
        // var endingdate = @php echo json_encode($endingdate); @endphp;
        var warehouse_id = @php echo json_encode($warehouseid); @endphp;
        var purchase_status = @php echo json_encode($purchasestatus); @endphp;
    ...
    <script type="text/javascript">
        ...
        function purchaseDetails(
            ...
            var htmltext = '<strong>{{ trans('Date') }}: </strong>' + date +
                ...
                '<br><strong>{{ trans('Purchase Status') }}: </strong>' + purchase_status +
            ...
            var id = purchase;
            var url = "{{ route('superAdmin.purchases.product_purchase', ':id') }}";
            ...
            var htmlfooter = '<p><strong>{{ trans('Note') }}:</strong> ' + note +
                '</p><strong>{{ trans('Created By') }}:</strong><br>' + user_name + '<br>' + user_email;
        ...
        $(document).on("click", "table.purchase-list tbody .get-payment", function(event) {
            ...
            var url = "{{ route('superAdmin.purchases.getpayment', ':id') }}";
            ...
            $.get(listUrl, function(data) {
                ...
                $.each(payment_date, function(index) {
                    ...
                    cols +=
                        '{{ Form::open(['route' => 'superAdmin.purchase.delete-payment', 'method' => 'post']) }}<li><input type="hidden" name="id" value="' +
                        payment_id[index] +
