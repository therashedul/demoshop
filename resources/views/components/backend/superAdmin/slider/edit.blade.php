...
@section('content')
    <style>
        ...
        div#slider_select_image_container {
            width: 80%;
            height: auto;
        }

        div#slider_select_image_container .slider-select-image-container img {
            width: 100%;
        }
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form action="{{ route('superAdmin.slider.update', $slider->id) }}" method="post"
                        ...
                        <div class="lang">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" name="imagename" value="{{ $slider->imagename }}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" name="imagecaption" value="{{ $slider->imagecaption }}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Image:
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                        ...
                                        @if (!empty($slider->image))
                                            <div id="slider_select_image_container" class="slider-select-image-container">
                                                @if ($slider->image != null)
                                                    <button class="pull-right mt-2" onclick="displayimageRemove()"
                                                        id="btn_delete">
                                                        <i class="fa fa-times"></i>
                                                    </button>
                                                @endif
                                                <img src="{{ asset('images/' . $slider->image) }}" id="selected_image_file"
                                                    alt="" class="img-fluid">
                                            </div>
                                        @else
                                            <div id="slider_select_image_container" class="slider-select-image-container">
                                                <img src="{{ asset('img/profile/profile-image.png') }}" width="170px"
                                                    height="200px" alt="" title="">
                                            </div>
                                        @endif
                                    </div>
                                    <input type="hidden" name="upload_id" value="{{ $slider->image_id }}">
                                    <input type="hidden" name="image_id" id="image_id" value="{{ $slider->image_id }}">
                                    <input type="hidden" name="image_name" id="image_name" value="{{ $slider->image }}">
                                    <input type="hidden" name="alt" id="alt_value" value="{{ $slider->alt }}">
                                    <input type="hidden" name="title" id="title_value" value="{{ $slider->title }}">
                                    <input type="hidden" name="caption" id="caption_value" value="{{ $slider->caption }}">
    ...
    <div class="modal fade" id="image_file_manager">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                {{-- {!! Form::open(['method' => 'get', 'route' => 'user.slider.destroy', 'enctype' => 'multipart/form-data', 'id' => 'myform']) !!} --}}
