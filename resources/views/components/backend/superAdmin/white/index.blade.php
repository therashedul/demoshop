...
@section('content')
    <div class="col-md-12 col-sm-12  ">
        <div class="x_panel">
            ...
            <div class="x_content">
                <div class="clearfix"></div>
                <a class="btn btn-primary mb-2 ml-2" href="{{ route('superAdmin.white.create') }}">Add IP </a>
                    ...
                    <tbody>
                        @foreach ($whitelists as $value)
                            <tr>
                                ...
                                <td>{{ $value->ip }}</td>
                                <td>
                                    <a href="{{ route('superAdmin.white.edit', $value->id) }}"
                                        class="btn btn-primary btn-sm"><i class="fa fa-pencil-square"
                                            aria-hidden="true"></i></a>
                                    <a href="{{ route('superAdmin.white.delete', $value->id) }}"
