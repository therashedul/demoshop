                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="purchase_status" class="form-control">
                                                                        @if ($lims_purchase_data->purchase_status == '1')
                                                                        ...
                                                                        @elseif ($lims_purchase_data->purchase_status == '2')
                                                                            <option value="1">
                                                                                {{ trans('Recieved') }}</option>
                                                                            <option selected="2">
                                                                                {{ trans('Partial') }}</option>
                                                                            ...
                                                                            <option value="4">
                                                                                {{ trans('Ordered') }}</option>
                                                                        @elseif ($lims_purchase_data->purchase_status == '3')
                                                                            <option value="1">
                                                                                {{ trans('Recieved') }}</option>
                                                                            <option value="2">
                                                                                {{ trans('Partial') }}</option>
                                                                            ...
                                                                            <option value="4">
                                                                                {{ trans('Ordered') }}</option>
                                                                        @elseif ($lims_purchase_data->purchase_status == '4')
                                                                            <option value="1">
                                                                                {{ trans('Recieved') }}</option>
                                                                            <option value="2">
                                                                                {{ trans('Partial') }}</option>
