            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{trans('Update Transfer')}}</h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small>{{trans('The field labels marked with * are required input fields')}}.</small></p>
                        {!! Form::open(['route' => ['superAdmin.transfers.update', ['id'=>$lims_transfer_data->id] ], 'method' => 'put', 'files' => true, 'id' => 'transfer-form']) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{trans('From Warehouse')}} *</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{trans('To Warehouse')}} *</label>
...
var url = "{{ route('superAdmin.transfers/getproduct', ':id') }}";
...
function productSearch(data){
    var urlSearch = "{{route('superAdmin.product_transfer.search')}}";
    $.ajax({
        type: 'GET',
        url: urlSearch,
        data: {
