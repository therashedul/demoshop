            ...
            <div class="card">
                <div class="card-header">Edit User
                    <span class="float-right">
                        <a class="btn btn-primary" href="{{ route('superAdmin.users') }}">User</a>
                    </span>
                </div>
                <div class="card-body">
                    {!! Form::model($user, [
                        'route' => ['superAdmin.users.update', $user->id],
                        'method' => 'PATCH',
                    ...
                    <div class="col-md-12" id="NewClass">
                        <div class="form-group">
                            <strong>Image:</strong>
                            ...
                            @if (!empty($user->profile_image))
                                <div id="post_select_image_container" class="post-select-image-container">
                                    ...
                                    @endif
                                    <img src="{{ asset('images/' . $user->profile_image) }}" id="selected_image_file"
                                        alt="">
                                </div>
                            @else
                                <div id="post_select_image_container" class="post-select-image-container">
                            ...
                            @endif
                            <input type="hidden" name="upload_id" value="{{ $user->image_id }}">
                            <input type="hidden" name="image_id" id="image_id" value="{{ $user->image_id }}">
                            <input type="hidden" name="image_name" id="image_name" value="{{ $user->profile_image }}">
