    ...
    <div class="modal  fade" id="ajaxModelexa" tabindex="-1" aria-labelledby="addbrandModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable brand-modal">
            {{-- <form method="POST" action="{{ route('superAdmin.brand.store') }}" enctype="multipart/form-data"
                    style="width: 100%;"> --}}
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.publish', function(e) {
            ...
            var url = "{{ route('superAdmin.brand.publish', ':id') }}";
        ...
        $(document).on('click', '.unpublish', function(e) {
            e.preventDefault();
            let id = $(this).data('id');
            let url = "{{ route('superAdmin.brand.unpublish', ':id') }}";
        ...
        $(function() {
            ...
            $('#submit-all').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('superAdmin.brand.store') }}",
                    type: "POST",
            ...
            $('body').on('click', '.editPost', function() {
                ...
                var url = "{{ route('superAdmin.brand.update', ':id') }}";
            ...
            $('body').on('click', '.deletebrand', function(e) {
                ...
                var url = "{{ route('superAdmin.brand.deleted', ':id') }}";
                var catUrl = url.replace(':id', id);
