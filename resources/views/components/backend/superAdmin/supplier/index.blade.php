...
@section('content')
    ...
    <div class="modal  fade" id="ajaxModelexa" tabindex="-1" aria-labelledby="addsupplierModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable supplier-modal">
            {{-- <form method="POST" action="{{ route('superAdmin.supplier.store') }}" enctype="multipart/form-data"
                    style="width: 100%;"> --}}
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.publish', function(e) {
            ...
            var url = "{{ route('superAdmin.supplier.publish', ':id') }}";
        ...
        $(document).on('click', '.unpublish', function(e) {
            e.preventDefault();
            let id = $(this).data('id');
            let url = "{{ route('superAdmin.supplier.unpublish', ':id') }}";
        ...
        $(function() {
            ...
            $('#submit-all').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('superAdmin.supplier.store') }}",
                    type: "POST",
            ...
            $('body').on('click', '.editPost', function() {
                ...
                var url = "{{ route('superAdmin.supplier.update', ':id') }}";
            ...
            $('body').on('click', '.deletesupplier', function(e) {
                ...
                var url = "{{ route('superAdmin.supplier.deleted', ':id') }}";
                var catUrl = url.replace(':id', id);
...
{{-- <x-backend.superAdmin.supplier.catindex :categories="$categories" /> --}}
