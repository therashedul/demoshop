...
<section>
    <div class="container-fluid">
            ...
            <div class="row ml-1 mt-2">
                {{-- <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="daterangepicker-field form-control btnchange"
                            value="{{ $startingdate }} To {{ $endingdate }}" required />
                        <input type="hidden" name="start_date" value="{{ $startingdate }}" />
                        <input type="hidden" name="end_date" value="{{ $endingdate }}" />
                    </div>
                </div> --}}
                ...
                <div class="col-md-2 ">
                    {{-- <div class="form-group">
                        ...
                        <select id="warehouse_id" class="form-control warehouse_id" name="warehouse_id" data-live-search="true" data-live-search-style="begins">
        ...
        <div class="row justify-content-center align-items-center g-2">
            <a href="{{ route('superAdmin.sale.create') }}" class="btn  btn-primary"><i class="dripicons-plus"></i>
            {{ trans('Add Sale') }}</a>&nbsp;
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-1">
                        ...
                        <select name="paid_by_id" class="form-control">
                            ...
                            @if ($limsrewardpointsettingdata->is_active)
                ...
                <div class="gift-card form-group">
                    ...
                    <select id="gift_card_id" name="gift_card_id" class="selectpicker form-control"
                        ...
                        @php
                            ...
                            $expired_date = [];
                        @endphp
                        @foreach ($limsgiftcardlist as $gift_card)
                            @php
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <select name="courier_id" class="form-control upcourier" data-live-search="true"
                            ...
                            @foreach ($limsdelivereslist as $couriar)
...
@push('custom_scripts')
    <script type="text/javascript">
        ...
        var starting_date = @php echo json_encode($startingdate); @endphp;
        var ending_date = @php echo json_encode($endingdate); @endphp;
        var warehouse_id = @php echo json_encode($warehouseid); @endphp;
        var sale_status = @php echo json_encode($salestatus); @endphp;
        var payment_status = @php echo json_encode($paymentstatus); @endphp;
        ...
        var table = $('.data-table').DataTable({
            ...
            drawCallback: function(row, data, start, end, display) {
                ...
                // Update footer
                $(api.column(9).footer()).html(Math.round(pageTotal).toLocaleString('en-IN'));
                $(api.column(10).footer()).html(Math.round(pageTotalReturnAmount).toLocaleString('en-IN'));
                //.toFixed(2) for floting link:23.55 Taka
                $(api.column(11).footer()).html(Math.round(pageTotalpaid).toLocaleString('en-IN'));
                $(api.column(12).footer()).html(Math.round(pageTotaldue).toLocaleString('en-IN'));
        ...
        $('body').on('click', '.deletesale', function(e) {
            ...
            var url = "{{ route('superAdmin.sale.deleted', ':id') }}";
