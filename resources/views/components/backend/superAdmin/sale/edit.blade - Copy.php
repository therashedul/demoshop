                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    @endphp
                                                        ...
                                                        <input type="hidden" class="product_variant_id" name="product_variant_id[]" value="{{$product_variant_id}}"/>
        ...
        if (rownumber < 0) {
            ...
            if($('input[name="coupon_type"]').val() == 'fixed'){
                if( $('input[name="grand_total"]').val() >= $('input[name="coupon_minimum_amount"]').val() ) {
                    ...
                    alert('Grand Total is not sufficient for discount! Required '+  + ' ' +$('input[name="coupon_minimum_amount"]').val());
            }
            else{
