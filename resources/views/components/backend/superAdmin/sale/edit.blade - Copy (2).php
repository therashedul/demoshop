                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="sale_id" value="{{$limssaledata->id}}"  class="form-control">
                                            @php
                                                // print_r($lims_product_sale_data[0]->id);
                                            @endphp
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    @endphp
                                                        ...
                                                        <input type="hidden"   class="product_variant"  name="product_variant_id[]" value="{{$product_variant_id}}"/>
