                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            @if($limspossettingdata)
                                            <input type="hidden" name="biller_id_hidden" value="{{$limspossettingdata->biller_id}}">
                                            @endif
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            @if($limspossettingdata)
                                            <input type="hidden" name="customer_id_hidden" value="{{$limspossettingdata->customer_id}}">
                                            @endif
          ...
          <div class="row">
            ...
            <div id="recentTransaction" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 id="exampleModalLabel" class="modal-title">{{trans('Recent Transaction')}} <div class="badge badge-primary">{{trans('latest')}} 10</div></h5>
                      <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                    </div>
                    <div class="modal-body">
                        <ul class="nav nav-tabs" role="tablist">
                          ...
                          <li class="nav-item">
                            <a class="nav-link" href="#draft-latest" role="tab" data-toggle="tab">{{trans('Draft')}}</a>
                          </li>
                        </ul>
