@extends('layouts.top-head') @section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        {!! Form::open(['route' => 'superAdmin.sale.store', 'method' => 'post', 'files' => true, 'class' => 'payment-form']) !!}
                        @php
                            if($lims_pos_setting_data)
                                $keybord_active = $lims_pos_setting_data->keybord_active;
                            else
                                $keybord_active = 0;
                                // print_r($lims_sale_data);
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        <table id="myTable" class="table table-hover table-striped order-list table-fixed">
                                            ...
                                            @endphp
                                                ...
                                                @endphp
                                                    <td class="col-sm-2 product-title"><strong>{{$product_data->product_name}}</strong> [{{$product_data->product_code}}] <button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"> <i class="dripicons-document-edit"></i></button> </td>
                                ...
                                <div class="col-12 totals" style="border-top: 2px solid #e4e6fc; padding-top: 10px;">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <span class="totals-title">{{trans('Items')}}</span><span id="item">{{$lims_sale_data->item}} ({{$lims_sale_data->total_qty}})</span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title">{{trans('Total')}}</span><span id="subtotal">{{number_format((float)$lims_sale_data->total_price, 2, '.', '')}}</span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title">{{trans('Discount')}} <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#order-discount"> <i class="dripicons-document-edit"></i></button></span>
                                        ...
                                        <div class="col-sm-4">
                                            <span class="totals-title">{{trans('Coupon')}} <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#coupon-modal"><i class="dripicons-document-edit"></i></button></span>
                                        ...
                                        <div class="col-sm-4">
                                            <span class="totals-title">{{trans('Tax')}} <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#order-tax"><i class="dripicons-document-edit"></i></button></span>
                                        ...
                                        <div class="col-sm-4">
                                            <span class="totals-title">{{trans('Shipping')}} <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#shipping-cost-modal"><i class="dripicons-document-edit"></i></button></span>
                    ...
                    <div class="payment-amount">
                        <h2>{{trans('grand total')}} <span id="grand-total">{{number_format((float)$lims_sale_data->grand_total, 2, '.', '')}}</span></h2>
                    </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <div class="mt-3">
                                        <button id="submit-btn" type="submit" class="btn btn-primary">{{trans('submit')}}</button>
                                    </div>
                                </div>
            ...
            <div class="col-md-6">
                      ...
                      <div class="container-fluid">
                        <div class="navbar-holder d-flex align-items-center justify-content-between">
                          ...
                          <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                            ...
                            <li class="nav-item"><a class="dropdown-item" href="{{route('superAdmin.possetting')}}"><i class="dripicons-gear"></i>  <span>{{trans('POS Setting')}}</span></a> </li>
                            {{-- @if($alert_product > 0) --}}
                            <li class="nav-item">
                                  ...
                                  <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default notifications" user="menu">
                                      <li class="notifications">
                                        <a href="{{route('superAdmin.report.qtyAlert')}}" class="btn btn-link">
                                            {{-- {{$alert_product}} --}}
                            ...
                            <li class="nav-item">
                                  ...
                                  <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                      ...
                                      <li>
                                        <a href="{{route('superAdmin.ganeralsetting')}}"><i class="dripicons-gear"></i> {{trans('settings')}}</a>
                                      </li>
                                      <li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <button class="btn btn-block btn-danger" id="featured-filter">{{trans('Featured')}}</button>
                    </div>
                    <div class="col-md-12 mt-1 table-container">
                        <table id="product-table" class="table product-list">
                            ...
                            @for ($i=0; $i < ceil($product_number/5); $i++)
                                <tr>
                                    <td class="product-img sound-btn" title="{{$lims_product_list[0+$i*5]->product_name}}" data-product ="{{$lims_product_list[0+$i*5]->product_code . ' (' . $lims_product_list[0+$i*5]->product_name . ')'}}"><img  src="{{url('public/images/product',$lims_product_list[0+$i*5]->base_image)}}" width="100%" />
                                        <p>{{$lims_product_list[0+$i*5]->product_name}}</p>
                                        <span>{{$lims_product_list[0+$i*5]->product_code}}</span>
                                    </td>
                                    @if(!empty($lims_product_list[1+$i*5]))
                                    <td class="product-img sound-btn" title="{{$lims_product_list[1+$i*5]->product_name}}" data-product ="{{$lims_product_list[1+$i*5]->product_code . ' (' . $lims_product_list[1+$i*5]->product_name . ')'}}"><img  src="{{url('public/images/product',$lims_product_list[1+$i*5]->base_image)}}" width="100%" />
                                        <p>{{$lims_product_list[1+$i*5]->product_name}}</p>
                                        <span>{{$lims_product_list[1+$i*5]->product_code}}</span>
                                    </td>
                                    @else
                                    <td style="border:none;"></td>
                                    @endif
                                    @if(!empty($lims_product_list[2+$i*5]))
                                    <td class="product-img sound-btn" title="{{$lims_product_list[2+$i*5]->product_name}}" data-product ="{{$lims_product_list[2+$i*5]->product_code . ' (' . $lims_product_list[2+$i*5]->product_name . ')'}}"><img  src="{{url('public/images/product',$lims_product_list[2+$i*5]->base_image)}}" width="100%" />
                                        <p>{{$lims_product_list[2+$i*5]->product_name}}</p>
                                        <span>{{$lims_product_list[2+$i*5]->product_code}}</span>
                                    </td>
                                    @else
                                    <td style="border:none;"></td>
                                    @endif
                                    @if(!empty($lims_product_list[3+$i*5]))
                                    <td class="product-img sound-btn" title="{{$lims_product_list[3+$i*5]->product_name}}" data-product ="{{$lims_product_list[3+$i*5]->product_code . ' (' . $lims_product_list[3+$i*5]->product_name . ')'}}"><img  src="{{url('public/images/product',$lims_product_list[3+$i*5]->base_image)}}" width="100%" />
                                        <p>{{$lims_product_list[3+$i*5]->product_name}}</p>
                                        <span>{{$lims_product_list[3+$i*5]->product_code}}</span>
                                    </td>
                                    @else
                                    <td style="border:none;"></td>
                                    @endif
                                    @if(!empty($lims_product_list[4+$i*5]))
                                    <td class="product-img sound-btn" title="{{$lims_product_list[4+$i*5]->product_name}}" data-product ="{{$lims_product_list[4+$i*5]->product_code . ' (' . $lims_product_list[4+$i*5]->product_name . ')'}}"><img  src="{{url('public/images/product',$lims_product_list[4+$i*5]->base_image)}}" width="100%" />
                                        <p>{{$lims_product_list[4+$i*5]->product_name}}</p>
                                        <span>{{$lims_product_list[4+$i*5]->product_code}}</span>
                                    </td>
                                    @else
                                    <td style="border:none;"></td>
                                    @endif
...
var product_row_number = @php echo json_encode($lims_pos_setting_data->product_number) @endphp;
var rowindex;
...
var coupon_list = @php echo json_encode($lims_coupon_list) @endphp;
...
$("#myTable").on("change", ".batch-no", function () {
    ...
    var warehouse_id = $('#warehouse_id').val();
    $.get('superAdmin.sale.checkBatchAvailability/' + product_id + '/' + $(this).val() + '/' + warehouse_id, function(data) {
        if(data['message'] != 'ok') {
            alert(data['message']);
