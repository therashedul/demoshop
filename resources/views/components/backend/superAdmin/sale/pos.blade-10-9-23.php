                          ...
                          <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                            ...
                            {{-- <li class="nav-item" id="notification-icon">
                                  <a rel="nofollow" data-toggle="tooltip" title="{{__('Notifications')}}" class="nav-link dropdown-item"><i class="dripicons-bell"></i>
                                    <span class="badge badge-danger notification-number">{{$alert_product + count(\Auth::user()->unreadNotifications)}}</span>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <div class="btn-group">
                                            ...
                                            {{ Form::open(['route' => ['superAdmin.sale.deleted', $sale->id], 'method' => 'DELETE'] ) }}
