    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form method="POST" action="{{ route('superAdmin.gallery.store') }}" enctype="multipart/form-data">
                        @csrf
    ...
    <div class="modal fade" id="image_file_manager" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                {{-- {!! Form::open(['method' => 'get', 'route' => 'superAdmin.users.destroy', 'enctype' => 'multipart/form-data', 'id' => 'myform']) !!} --}}
