            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'superAdmin.rewardPointSettingStore', 'files' => true, 'method' => 'post']) !!}
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        @if(!empty($lims_reward_point_setting_data->per_point_amount))
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="type" class="form-control">
                                            @if(!empty($lims_reward_point_setting_data->type))
