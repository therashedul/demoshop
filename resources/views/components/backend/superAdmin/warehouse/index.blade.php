...
@section('content')
    ...
    <div class="modal  fade" id="ajaxModelexa" tabindex="-1" aria-labelledby="addwarehouseModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable warehouse-modal">
            {{-- <form method="POST" action="{{ route('superAdmin.warehouse.store') }}" enctype="multipart/form-data"
                    style="width: 100%;"> --}}
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.publish', function(e) {
            ...
            var url = "{{ route('superAdmin.warehouse.publish', ':id') }}";
        ...
        $(document).on('click', '.unpublish', function(e) {
            e.preventDefault();
            let id = $(this).data('id');
            let url = "{{ route('superAdmin.warehouse.unpublish', ':id') }}";
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('superAdmin.warehouse') }}",
                    data: function(d) {
            ...
            $('#submit-all').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('superAdmin.warehouse.store') }}",
                    type: "POST",
            ...
            $('body').on('click', '.deletewarehouse', function(e) {
                ...
                var url = "{{ route('superAdmin.warehouse.deleted', ':id') }}";
