                                            ...
                                            <form action="{{ route('superAdmin.products.store') }}" method="POST"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 mt-2" id="diffPrice-option">
                                                        <h5>
                                                            <input name="is_diffPriceWareHouse" type="checkbox"
                                                                id="is_diffPriceWareHouse" value="1">&nbsp; This
                                                            product
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" name="end_date"
                                                                            id="ending_date" class="form-control" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
    ...
    <script type="text/javascript">
        ...
        $('select[name="product_type"]').on('change', function() {
            if ($(this).val() == 'combo') {
                ...
                $("#is_diffPriceWareHouse").prop("checked", false);
