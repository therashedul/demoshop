...
<body class="hold-transition sidebar-mini layout-fixed" onbeforeunload="MyFunction();">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <p class="italic"><small>The field labels marked with * are required
                                                    input
                                                    fields.</small></p>
                                            <form action="{{ route('superAdmin.products.update') }}" method="POST"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <form id="product-form">
                                                    <input type="hidden" name="id"
                                                        value="{{ $limsproductdata->id }}" />
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="hidden" name="type_hidden"
                                                                        value="{{ $limsproductdata->product_type }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="name"
                                                                    value="{{ $limsproductdata->product_name }}"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" name="product_code"
                                                                        value="{{ $limsproductdata->product_code }}"
                                                        ...
                                                        <div id="combo" class="col-md-9 mb-1">
                                                            ...
                                                            <label>{{ trans('Combo Products') }}</label>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <input type="hidden" name="brand"
                                                                    value="{{ $limsproductdata->brand_id }}">
                                                                <label>{{ trans('brand') }} *</strong> </label>
                                                                <div class="input-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <input type="hidden" name="category"
                                                                    value="{{ $limsproductdata->category_id }}">
                                                                <label>{{ trans('category') }} *</strong> </label>
                                                                <div class="input-group">
                                                        ...
                                                        <div id="cost" class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number"
                                                                    value="{{ $limsproductdata->product_cost }}"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number"
                                                                    value="{{ $limsproductdata->product_price }}"
                                                        ...
                                                        <div id="alert-qty" class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="alert_qty"
                                                                    value="{{ $limsproductdata->alert_qty }}"
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="hidden" name="sale_unit"
                                                                            value="{{ $limsproductdata->sale_unit_id }}">
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="hidden" name="purchase_unit"
                                                                                value="{{ $limsproductdata->purchase_unit_id }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <select id="stateDropdown"
                                                                            class="form-control selectpicker changeUnit"
                                                                            data-live-search="true"
                                                                            data-live-search-style="begins"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <input type="hidden" name="tax_method_id"
                                                                    value="{{ $limsproductdata->tax_method }}">
                                                                <label>{{ trans('Tax Method') }}</strong> </label>
                                                                <select name="tax_method"
                                                                    class="form-control selectpicker">

                                                                    @if ($limsproductdata->tax_method == '1')
                                                                        <option selected value="1">
                                                                            {{ trans('Exclusive') }}</option>

                                                                        <option value="2">
                                                                            {{ trans('Inclusive') }}</option>
                                                                    @else
                                                        ...
                                                        <div id="regular_price" class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="product_regular_price"
                                                                    value="{{ $limsproductdata->product_regular_price }}"
                                                                    class="form-control" step="any">
                                                            </div>
                                                        </div>
                                                        <div id="sell_price" class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="product_sell_price"
                                                                    value="{{ $limsproductdata->product_sell_price }}"
                                                                    class="form-control" step="any">
                                                            </div>
                                                        </div>
                                                        {{-- ===================== --}}
                                                                ...
                                                                <div class="col-md-6 form-group col-sm-6">
                                                                    <div class="x_content" id="">
                                                                        <div class="form-group">
                                                                            ...
                                                                            @if (!empty($limsproductdata->product_image))
                                                                                <div id="post_select_image_container"
                                                                                    class="post-select-image-container">
                                                                                    @if ($limsproductdata->product_image != null)
                                                                                    ...
                                                                                    @endif
                                                                                    <img src="{{ asset('images/' . $limsproductdata->product_image) }}"
                                                                            ...
                                                                            @else
                                                                                <div id="post_select_image_container"
                                                                                    ...
                                                                                    <a href=""
                                                                                        ...
                                                                                        data-toggle="modal"
                                                                                        data-target="#image_file_manager">
                                                                                        <img src="{{ asset('img/profile/blank-img.jpg') }}"
                                                                                            width="170px"
                                                                                            height="200px"
                                                                                            alt=""
                                                                                            title="">
                                                                            ...
                                                                            <input type="hidden" name="image_name"
                                                                                id="image_name"
                                                                                value="{{ $limsproductdata->product_image }}">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            {{ str_replace('@', '"', $limsproductdata->product_details) }}</textarea>
                                                        ...
                                                        <div class="col-md-12">
                                                            <h5>
                                                                <input type="hidden" value="0"
                                                                    ...
                                                                    {{ $limsproductdata->is_active == 0 ? 'checked' : '' }}>
                                                                <input type="checkbox" value="1"
                                                                    class="js-switch" name="status"
                                                                    {{ $limsproductdata->is_active == 1 ? 'checked' : '' }}>
                                                                &nbsp;
                                                                Status
                                                            </h5>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <h5>
                                                                <input type="hidden" value="0"
                                                                    ...
                                                                    {{ $limsproductdata->trending == 0 ? 'checked' : '' }}>
                                                                <input type="checkbox" value="1"
                                                                    class="js-switch" name="trending"
                                                                    {{ $limsproductdata->trending == 1 ? 'checked' : '' }}>
                                                                &nbsp;
                                                                Tranding
                                                            </h5>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12 mt-3" id="variant-option">
                                                            @if ($limsproductdata->is_variant)
                                                                <h5 class="d-none"><input name="is_variant"
                                                                        type="checkbox" id="is-variant"
                                                                        value="1" checked>&nbsp;
                                                                    {{ trans('This product has variant') }}</h5>
                                                            @else
                                                                <h5><input name="is_variant" type="checkbox"
                                                                        id="is-variant" value="1">&nbsp;
                                                                    {{ trans('This product has variant') }}
                                                                </h5>
                                                            @endif
                                                        </div>
                                                        <div class="col-md-12" id="variant-section">
                                                            @if ($limsproductdata->variant_option)
                                                                <div class="row" id="variant-input-section">
                                                                    @foreach ($limsproductdata->variant_option as $key => $variant_option)
                                                                        <?php
                                                                        ...
                                                                        <div class="col-md-4 form-group mt-2">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                value="{{ $limsproductdata->variant_option[$key] }}">
                                                                        </div>
                                                                        <div class="col-md-6 form-group mt-2">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                value="{{ $limsproductdata->variant_value[$key] }}">
                                                                        </div>
                                                                    @endforeach
                                                                </div>
                                                            @endif
                                                                ...
                                                                <table id="variant-table"
                                                                    ...
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th>{{ trans('Additional Cost') }} </th>
                                                                            <th>{{ trans('Additional Price') }} </th>
                                                                            <th>{{ trans('Stock') }}</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>

                                                                        @foreach ($limsproductvariantdata as $key => $variant)
                                                                            <tr>
                                                        ...
                                                        <div class="col-md-12 mt-2" id="diffPrice-option">
                                                            @if ($limsproductdata->is_diffPriceWareHouse)
                                                                <h5><input name="is_diffPriceWareHouse"
                                                                        type="checkbox" id="is-diffPrice"
                                                                        value="1" checked>&nbsp;
                                                                    {{ trans('This product has different price for different warehouse') }}
                                                                </h5>
                                                            @else
                                                                <h5><input name="is_diffPriceWareHouse"
                                                                        type="checkbox" id="is-diffPrice"
                                                        ...
                                                        <div class="col-md-12 mt-3" id="batch-option">
                                                            @if ($limsproductdata->is_batch)
                                                                <h5><input name="is_batch" type="checkbox"
                                                                        id="is-batch" value="1" checked>&nbsp;
                                                                    {{ trans('This product has batch and expired date') }}
                                                                </h5>
                                                            @else
                                                                <h5><input name="is_batch" type="checkbox"
                                                                        id="is-batch" value="1">&nbsp;
                                                        ...
                                                        <div class="col-md-4 mt-3">
                                                            <input type="hidden" name="promotion_hidden"
                                                                value="{{ $limsproductdata->promotion }}">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4" id="promotion_price">
                                                                    ...
                                                                    <input type="number" name="promotion_price"
                                                                        value="{{ $limsproductdata->promotion_price }}"
                                                                        class="form-control" step="any" />
                                                                </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" name="start_date"
                                                                                value="{{ $limsproductdata->start_date }}"
                                                                                id="starting_date"
                                                                                class="form-control" />
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" name="last_date"
                                                                                value="{{ $limsproductdata->end_date }}"
                                                                                id="last_date"
                                                                                class="form-control" />
                                                                        </div>
                                                                    </div>
    ...
    <script type="text/javascript">
        ...
        var product_id = @php   echo json_encode($limsproductdata->id); @endphp;
        var is_batch = @php   echo json_encode($limsproductdata->is_batch); @endphp;
        var is_variant = @php   echo json_encode($limsproductdata->is_variant); @endphp;
        var redirectUrl = @php   echo json_encode(url('products')); @endphp;
        var variantPlaceholder = @php   echo json_encode(trans('Enter variant value seperated by comma')); @endphp;
        var variantIds = [];
        var combinations = [];
        var oldCombinations = [];
        var step;
        ...
        //     $("#sellDropdown").html('');
        //     $.ajax({
        //         url: "{{ route('superAdmin.products.sellUnit') }}",
        //         type: "POST",
        //         data: {
        //             unit_id: unit_id,
        //             _token: '{{ csrf_token() }}'
        ...
        //     $.ajax({
        //         url: "{{ route('superAdmin.products.purchaseUnit') }}",
        //         type: "POST",
        //         data: {
        ...
        function populate_unit(unitID) {
            var url = "{{ route('superAdmin.products.sellUnitId', ':id') }}";
        ...
        function populate_unit_second(unitID) {
            ...
            var url = "{{ route('superAdmin.products.purchaseUnitId', ':id') }}";
