...
<body class="hold-transition sidebar-mini layout-fixed" onbeforeunload="MyFunction();">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="{{ route('superAdmin.products.store') }}" method="POST"
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" name="product_code"
                                                                    class="form-control barcode" id="codegenerotor"
                                                                    aria-describedby="code" maxlength="8"
                                                    ...
                                                    <div class="col-md-12 mt-3" id="variant-option">
                                                        <h5><input name="is_variant" type="checkbox" id="is-variant"
    ...
    <script type="text/javascript">
        ...
        function generateSerial() {
            ...
            document.getElementById('codegenerotor').value = randomSerial;
        }
