...
@section('content')
    ...
    <div class="modal  fade" id="ajaxModelexa" tabindex="-1" aria-labelledby="addcustomerModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable customer-modal">
            <form method="POST" action="{{ route('superAdmin.customer.store') }}" enctype="multipart/form-data"
                    style="width: 100%;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 ">
                                <select class="form-control up-gcustomer gcustomerName upgCustomer" id="gcustomerName"
                                    ...
                                    @foreach ($lims_customer_group_all as $customer)
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.publish', function(e) {
            ...
            var url = "{{ route('superAdmin.customer.publish', ':id') }}";
        ...
        $(document).on('click', '.unpublish', function(e) {
            e.preventDefault();
            let id = $(this).data('id');
            let url = "{{ route('superAdmin.customer.unpublish', ':id') }}";
        ...
        $(function() {
            ...
            $('#submit-all').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('superAdmin.customer.store') }}",
                    type: "POST",
            ...
            $('body').on('click', '.editPost', function() {
                ...
                var url = "{{ route('superAdmin.customer.update', ':id') }}";
            ...
            $('body').on('click', '.deletecustomer', function(e) {
                ...
                var url = "{{ route('superAdmin.customer.deleted', ':id') }}";
                var catUrl = url.replace(':id', id);
...
{{-- <x-backend.superAdmin.customer.catindex :categories="$categories" /> --}}
