            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'superAdmin.return-sale.store', 'method' => 'post', 'files' => true, 'class' => 'sale-return-form']) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-12">
                                                ...
                                                <tbody>
                                                    ...
                                                    @php
                                                        ...
                                                        if($product_data->product_type == 'standard'){
                                                            $unit = DB::table('units')->select('unit_code')->find($product_data->unit_id);
                                                        ...
                                                        print_r( $product_batch_data);
                                                    @endphp
                                                        <td>{{$product_data->product_name}}</td>
                                                        <td>{{$product_data->product_code}}</td>
                                                        @if($product_batch_data)
                                                        <td>
                                                            <input type="text" class="product-batch-id" name="product_batch_id[]" value="{{$product_sale->product_batch_id}}">
                                                            {{$product_batch_data->batch_no}}
                                                        </td>
                                                        @else
                                                        <td>
                                                            <input type="text" class="product-batch-id" name="product_batch_id[]" value="">
                                                            N/A
                                                        </td>
                                                        @endif
                                                        <td>
