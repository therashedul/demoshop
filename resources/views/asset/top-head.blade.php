...
<html>
  <head>
    ...
    <!-- jQuery Circle-->
    <link rel="preload" href="@php echo asset('css/grasp_mobile_progress_circle-1.0.0.min.css') @endphp" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link href="@php echo asset('css/grasp_mobile_progress_circle-1.0.0.min.css') @endphp" rel="stylesheet"></noscript>
    <!-- Custom Scrollbar-->
    ...
    <link rel="stylesheet" href="@php echo asset('css/style.default.css') @endphp" id="theme-stylesheet" type="text/css">
    <link rel="stylesheet" href="@php echo asset('css/style.css') @endphp">

    <!-- Custom stylesheet - for your changes-->
    <link rel="stylesheet" href="@php echo asset('css/custom-'.$general_setting->theme) @endphp" type="text/css" id="custom-style">
    @if( Config::get('app.locale') == 'ar' || $general_setting->is_rtl)
      ...
      <link rel="stylesheet" href="@php echo asset('css/custom-rtl.css') @endphp" type="text/css" id="custom-style">
    @endif
  ...
  <body class="pos-page" onload="myFunction()">
    ...
    <script type="text/javascript" src="@php echo asset('js/grasp_mobile_progress_circle-1.0.0.min.js') @endphp"></script>
    ...
    @if( Config::get('app.locale') == 'ar' || $general_setting->is_rtl)
      <script type="text/javascript" src="@php echo asset('js/front_rtl.js') @endphp"></script>
    @else
      <script type="text/javascript" src="@php echo asset('js/front.js') @endphp"></script>
    @endif
    ...
    <script type="text/javascript">
        ...
        //switch theme code
        var theme = @php echo json_encode($theme); @endphp;
        if(theme == 'dark') {
        ...
        $('#switch-theme').click(function() {
            if(theme == 'light') {
                theme = 'dark';
                var url = @php echo json_encode(route('switchTheme', 'dark')); @endphp;
                $('body').addClass('dark-mode');
                $('#switch-theme i').addClass('dripicons-brightness-low');
            }
            else {
                theme = 'light';
                var url = @php echo json_encode(route('switchTheme', 'light')); @endphp;
                $('body').removeClass('dark-mode');
                $('#switch-theme i').addClass('dripicons-brightness-max');
            }
