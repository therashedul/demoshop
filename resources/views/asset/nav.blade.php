<link rel="preload" href="{{ asset('css/daterangepicker.min.css') }}" as="style"
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item"> <a class="nav-link"
                                href="{{ route('superAdmin.expense_categories') }}">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item"> <a class="nav-link"
                                href="{{ route('superAdmin.accounts.balancesheet') }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Balancesheet</p>
                            </a>
                        </li>
                            ...
                            <ul id="report" class="collapse list-unstyled ">
                                <li id="profit-loss-report-menu">
                                    ...
                                    <button id="profitLossLink"
                                        href="">{{ trans('Summary Reporting') }}</button>
                                    {!! Form::close() !!}
                                </li>
                                ...
                                <li id="daily-sale-report-menu">
                                    <a
                                        href="{{ url('superAdmin/report/daily_sale/' . date('Y') . '/' . date('m')) }}">{{ trans('Daily Sale') }}</a>
                                </li>
                                <li id="monthly-sale-report-menu">
                                    <a
                                        href="{{ url('superAdmin/report/monthly_sale/' . date('Y')) }}">{{ trans('Monthly Sale') }}</a>
                                </li>
                                <li id="best-seller-report-menu">
                                    <a
                                        href="{{ url('superAdmin/report/best_seller') }}">{{ trans('Best Seller') }}</a>
                                </li>
                                <li id="daily-purchase-report-menu">
                                    <a
                                        href="{{ url('superAdmin/report/daily_purchase/' . date('Y') . '/' . date('m')) }}">{{ trans('Daily Purchase') }}</a>
                                </li>

                                <li id="monthly-purchase-report-menu">
                                    <a
                                        href="{{ url('superAdmin/report/monthly_purchase/' . date('Y')) }}">{{ trans('Monthly Purchase') }}</a>
                                </li>
                                ...
                                <li id="sale-report-chart-menu">
                                    ...
                                    <button id="sale-report-chart-link"
                                        href="">{{ trans('Sale Report Chart') }}</button>
                                    {!! Form::close() !!}
                                </li>
                                ...
                                <li id="payment-report-menu">
                                    ...
                                    <button id="payment-report-link"
                                        href="">{{ trans('Payment Report') }}</button>
                                    {!! Form::close() !!}
                                </li>
                                ...
                                <li id="purchase-report-menu">
                                    ...
                                    <button id="purchase-report-link"
                                        href="">{{ trans('Purchase Report') }}</button>
                                    {!! Form::close() !!}
                                </li>
                            ...
                            <button id="customer-report-link" href="">{{trans('Customer Report')}}</button>
                                ...
                                <li id="due-report-menu">
                                    ...
                                    <button id="due-report-link"
                                        href="">{{ trans('Customer Due Report') }}</button>
                                    {!! Form::close() !!}
                                </li>
                                ...
                                <li id="supplier-due-report-menu">
                                    ...
                                    <button id="supplier-due-report-link"
                                        href="">{{ trans('Supplier Due Report') }}</button>
                                    {!! Form::close() !!}
                                </li>
                                ...
                                <li id="warehouse-stock-report-menu">
                                    <a
                                        href="{{ route('superAdmin.report.warehouseStock') }}">{{ trans('Warehouse Stock Chart') }}</a>
                                </li>
                                <li id="productExpiry-report-menu">
                                    <a
                                        href="{{ route('superAdmin.report.productExpiry') }}">{{ trans('Product Expiry Report') }}</a>
                                </li>
                                <li id="qtyAlert-report-menu">
                                    <a
                                        href="{{ route('superAdmin.report.qtyAlert') }}">{{ trans('Product Quantity Alert') }}</a>
                                </li>
                                <li id="daily-sale-objective-menu">
                                    <button
                                        href="{{ route('superAdmin.report.dailySaleObjective') }}">{{ trans('Daily Sale Objective Report') }}</button>
                                </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item"> <a class="nav-link"
                                href="{{ route('superAdmin.rewardPointSetting') }}">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item"> <a class="nav-link" href="{{ route('superAdmin.possetting') }}">
                          ...
                          <li class="nav-item"> <a class="nav-link" href="{{ route('superAdmin.ganeralsetting.sms') }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>SMS Setting</p>
                            </a>
                        </li>
                          <li class="nav-item"> <a class="nav-link" href="{{ route('superAdmin.ganeralsetting.createSms') }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Send SMS</p>
                            </a>
                        </li>
                            <li class="nav-item"> <a class="nav-link" href="{{ route('superAdmin.ganeralsetting.superadminsetting') }}">
                                <i class="far fa-circle nav-icon"></i>
                    ...
                    <div class="form-group">
                        ...
                        <select name="user_id" class="selectpicker form-control" required data-live-search="true"
                            ...
                            @foreach ($lims_user_list as $user)
                                <option value="{{ $user->id }}">{{ $user->name . ' (' . $user->mobile . ')' }}
                                </option>
                            @endforeach
                        </select>
                    </div>
